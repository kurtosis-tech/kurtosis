...
import {
    ...
    ExecCommandResponse,
    ExecuteModuleArgs,
    ExecuteModuleResponse, ExecuteStartosisModuleArgs, ExecuteStartosisModuleResponse,
...
export interface GenericApiContainerClient {
    ...
    executeStartosisModule(startosisModuleArgs: ExecuteStartosisModuleArgs): Promise<Result<ExecuteStartosisModuleResponse, Error>>
