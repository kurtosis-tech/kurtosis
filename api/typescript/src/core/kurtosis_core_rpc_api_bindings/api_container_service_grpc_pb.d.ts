...
interface IApiContainerServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  executeKurtosisScript: grpc.MethodDefinition<api_container_service_pb.ExecuteStartosisScriptArgs, api_container_service_pb.KurtosisExecutionResponseLine>;
  ...
  executeKurtosisModule: grpc.MethodDefinition<api_container_service_pb.ExecuteStartosisModuleArgs, api_container_service_pb.KurtosisExecutionResponseLine>;
...
export interface IApiContainerServiceServer extends grpc.UntypedServiceImplementation {
  ...
  executeKurtosisScript: grpc.handleServerStreamingCall<api_container_service_pb.ExecuteStartosisScriptArgs, api_container_service_pb.KurtosisExecutionResponseLine>;
  ...
  executeKurtosisModule: grpc.handleServerStreamingCall<api_container_service_pb.ExecuteStartosisModuleArgs, api_container_service_pb.KurtosisExecutionResponseLine>;
...
export class ApiContainerServiceClient extends grpc.Client {
  ...
  executeKurtosisScript(argument: api_container_service_pb.ExecuteStartosisScriptArgs, metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null): grpc.ClientReadableStream<api_container_service_pb.KurtosisExecutionResponseLine>;
  executeKurtosisScript(argument: api_container_service_pb.ExecuteStartosisScriptArgs, metadata?: grpc.Metadata | null, options?: grpc.CallOptions | null): grpc.ClientReadableStream<api_container_service_pb.KurtosisExecutionResponseLine>;
  ...
  executeKurtosisModule(argument: api_container_service_pb.ExecuteStartosisModuleArgs, metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null): grpc.ClientReadableStream<api_container_service_pb.KurtosisExecutionResponseLine>;
  executeKurtosisModule(argument: api_container_service_pb.ExecuteStartosisModuleArgs, metadata?: grpc.Metadata | null, options?: grpc.CallOptions | null): grpc.ClientReadableStream<api_container_service_pb.KurtosisExecutionResponseLine>;
