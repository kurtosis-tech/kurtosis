...
goog.exportSymbol('proto.api_container_api.ExecuteStartosisScriptResponse', null, global);
...
goog.exportSymbol('proto.api_container_api.SerializedStartosisScript', null, global);
goog.exportSymbol('proto.api_container_api.SerializedStartosisScriptOutput', null, global);
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.api_container_api.ExecuteStartosisScriptResponse.displayName = 'proto.api_container_api.ExecuteStartosisScriptResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api_container_api.SerializedStartosisScript = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.SerializedStartosisScript, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.SerializedStartosisScript.displayName = 'proto.api_container_api.SerializedStartosisScript';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api_container_api.SerializedStartosisScriptOutput = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.SerializedStartosisScriptOutput, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.SerializedStartosisScriptOutput.displayName = 'proto.api_container_api.SerializedStartosisScriptOutput';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.api_container_api.ExecuteStartosisScriptArgs.toObject = function(includeInstance, msg) {
  var f, obj = {
    serializedScript: (f = msg.getSerializedScript()) && proto.api_container_api.SerializedStartosisScript.toObject(includeInstance, f)
  };
...
proto.api_container_api.ExecuteStartosisScriptArgs.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 2:
      var value = new proto.api_container_api.SerializedStartosisScript;
      reader.readMessage(value,proto.api_container_api.SerializedStartosisScript.deserializeBinaryFromReader);
...
proto.api_container_api.ExecuteStartosisScriptArgs.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.api_container_api.SerializedStartosisScript.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional SerializedStartosisScript serialized_script = 2;
 * @return {?proto.api_container_api.SerializedStartosisScript}
 */
proto.api_container_api.ExecuteStartosisScriptArgs.prototype.getSerializedScript = function() {
  return /** @type{?proto.api_container_api.SerializedStartosisScript} */ (
    jspb.Message.getWrapperField(this, proto.api_container_api.SerializedStartosisScript, 2));
};


/**
 * @param {?proto.api_container_api.SerializedStartosisScript|undefined} value
 ...
 * @return {!proto.api_container_api.ExecuteStartosisScriptArgs} returns this
 */
proto.api_container_api.ExecuteStartosisScriptArgs.prototype.clearSerializedScript = function() {
  return this.setSerializedScript(undefined);
};
 ...
 * @return {boolean}
 */
proto.api_container_api.ExecuteStartosisScriptArgs.prototype.hasSerializedScript = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Object}
 */
proto.api_container_api.ExecuteStartosisScriptResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.ExecuteStartosisScriptResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.ExecuteStartosisScriptResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.ExecuteStartosisScriptResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    serializedScriptOutput: (f = msg.getSerializedScriptOutput()) && proto.api_container_api.SerializedStartosisScriptOutput.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api_container_api.ExecuteStartosisScriptResponse}
 */
proto.api_container_api.ExecuteStartosisScriptResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.ExecuteStartosisScriptResponse;
  return proto.api_container_api.ExecuteStartosisScriptResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.ExecuteStartosisScriptResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.ExecuteStartosisScriptResponse}
 */
proto.api_container_api.ExecuteStartosisScriptResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.api_container_api.SerializedStartosisScriptOutput;
      reader.readMessage(value,proto.api_container_api.SerializedStartosisScriptOutput.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.ExecuteStartosisScriptResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.ExecuteStartosisScriptResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.ExecuteStartosisScriptResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.ExecuteStartosisScriptResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.api_container_api.SerializedStartosisScriptOutput.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional SerializedStartosisScriptOutput serialized_script_output = 1;
 * @return {?proto.api_container_api.SerializedStartosisScriptOutput}
 */
proto.api_container_api.ExecuteStartosisScriptResponse.prototype.getSerializedScriptOutput = function() {
  return /** @type{?proto.api_container_api.SerializedStartosisScriptOutput} */ (
    jspb.Message.getWrapperField(this, proto.api_container_api.SerializedStartosisScriptOutput, 1));
};


/**
 * @param {?proto.api_container_api.SerializedStartosisScriptOutput|undefined} value
 * @return {!proto.api_container_api.ExecuteStartosisScriptResponse} returns this
*/
proto.api_container_api.ExecuteStartosisScriptResponse.prototype.setSerializedScriptOutput = function(value) {
 ...
 * @return {!proto.api_container_api.ExecuteStartosisScriptResponse} returns this
 */
proto.api_container_api.ExecuteStartosisScriptResponse.prototype.clearSerializedScriptOutput = function() {
  return this.setSerializedScriptOutput(undefined);
};
 ...
 * @return {boolean}
 */
proto.api_container_api.ExecuteStartosisScriptResponse.prototype.hasSerializedScriptOutput = function() {
 ...
 * @return {!Object}
 */
proto.api_container_api.SerializedStartosisScript.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.SerializedStartosisScript.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.SerializedStartosisScript} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.SerializedStartosisScript.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.api_container_api.SerializedStartosisScript}
 */
proto.api_container_api.SerializedStartosisScript.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.SerializedStartosisScript;
  return proto.api_container_api.SerializedStartosisScript.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.SerializedStartosisScript} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.SerializedStartosisScript}
 */
proto.api_container_api.SerializedStartosisScript.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.SerializedStartosisScript.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.SerializedStartosisScript.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.SerializedStartosisScript} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.SerializedStartosisScript.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSerializedScript();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api_container_api.SerializedStartosisScript.prototype.getSerializedScript = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api_container_api.SerializedStartosisScript} returns this
 */
proto.api_container_api.SerializedStartosisScript.prototype.setSerializedScript = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.api_container_api.SerializedStartosisScriptOutput.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.SerializedStartosisScriptOutput.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.SerializedStartosisScriptOutput} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.SerializedStartosisScriptOutput.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.api_container_api.SerializedStartosisScriptOutput}
 */
proto.api_container_api.SerializedStartosisScriptOutput.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.SerializedStartosisScriptOutput;
  return proto.api_container_api.SerializedStartosisScriptOutput.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.SerializedStartosisScriptOutput} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.SerializedStartosisScriptOutput}
 */
proto.api_container_api.SerializedStartosisScriptOutput.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.SerializedStartosisScriptOutput.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.SerializedStartosisScriptOutput.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.SerializedStartosisScriptOutput} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.SerializedStartosisScriptOutput.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSerializedScriptOutput();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api_container_api.SerializedStartosisScriptOutput.prototype.getSerializedScriptOutput = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api_container_api.SerializedStartosisScriptOutput} returns this
 */
proto.api_container_api.SerializedStartosisScriptOutput.prototype.setSerializedScriptOutput = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
