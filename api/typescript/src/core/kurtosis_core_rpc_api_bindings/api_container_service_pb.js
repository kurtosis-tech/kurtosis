...
proto.api_container_api.ServiceInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    serviceDirPathsToFilesArtifactsIdentifiersMap: (f = msg.getServiceDirPathsToFilesArtifactsIdentifiersMap()) ? f.toObject(includeInstance, proto.api_container_api.FilesArtifactsList.toObject) : [],
...
/**
 * map<string, FilesArtifactsList> service_dir_paths_to_files_artifacts_identifiers = 10;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
