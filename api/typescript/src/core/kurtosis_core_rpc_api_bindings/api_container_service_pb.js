...
goog.exportSymbol('proto.api_container_api.FileArtifactChunk', null, global);
 ...
 * @constructor
 */
proto.api_container_api.FileArtifactChunk = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.FileArtifactChunk, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.FileArtifactChunk.displayName = 'proto.api_container_api.FileArtifactChunk';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.api_container_api.FileArtifactChunk.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.FileArtifactChunk.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.FileArtifactChunk} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.FileArtifactChunk.toObject = function(includeInstance, msg) {
  var f, obj = {
    data: msg.getData_asB64(),
    name: jspb.Message.getFieldWithDefault(msg, 2, ""),
    previousChunkHash: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api_container_api.FileArtifactChunk}
 */
proto.api_container_api.FileArtifactChunk.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.FileArtifactChunk;
  return proto.api_container_api.FileArtifactChunk.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.FileArtifactChunk} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.FileArtifactChunk}
 */
proto.api_container_api.FileArtifactChunk.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.FileArtifactChunk.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.FileArtifactChunk.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.FileArtifactChunk} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.FileArtifactChunk.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.api_container_api.FileArtifactChunk.prototype.getData = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.api_container_api.FileArtifactChunk.prototype.getData_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getData()));
};
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.FileArtifactChunk.prototype.getData_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getData()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.api_container_api.FileArtifactChunk} returns this
 */
proto.api_container_api.FileArtifactChunk.prototype.setData = function(value) {
 ...
 * @return {string}
 */
proto.api_container_api.FileArtifactChunk.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api_container_api.FileArtifactChunk} returns this
 */
proto.api_container_api.FileArtifactChunk.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional string previous_chunk_hash = 3;
 * @return {string}
 */
proto.api_container_api.FileArtifactChunk.prototype.getPreviousChunkHash = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.api_container_api.FileArtifactChunk} returns this
 */
proto.api_container_api.FileArtifactChunk.prototype.setPreviousChunkHash = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
