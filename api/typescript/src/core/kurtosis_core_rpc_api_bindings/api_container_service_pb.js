...
goog.exportSymbol('proto.api_container_api.FileNameAndUuid', null, global);
 ...
 * @constructor
 */
proto.api_container_api.FileNameAndUuid = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.FileNameAndUuid, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.FileNameAndUuid.displayName = 'proto.api_container_api.FileNameAndUuid';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.api_container_api.FileNameAndUuid.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.FileNameAndUuid.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.FileNameAndUuid} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.FileNameAndUuid.toObject = function(includeInstance, msg) {
  var f, obj = {
    filename: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api_container_api.FileNameAndUuid}
 */
proto.api_container_api.FileNameAndUuid.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.FileNameAndUuid;
  return proto.api_container_api.FileNameAndUuid.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.FileNameAndUuid} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.FileNameAndUuid}
 */
proto.api_container_api.FileNameAndUuid.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.FileNameAndUuid.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.FileNameAndUuid.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.FileNameAndUuid} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.FileNameAndUuid.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFilename();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api_container_api.FileNameAndUuid.prototype.getFilename = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api_container_api.FileNameAndUuid} returns this
 */
proto.api_container_api.FileNameAndUuid.prototype.setFilename = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api_container_api.FileNameAndUuid.prototype.getFileuuid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api_container_api.FileNameAndUuid} returns this
 */
proto.api_container_api.FileNameAndUuid.prototype.setFileuuid = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
...
proto.api_container_api.ListFilesArtifactNamesAndUuidsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.api_container_api.FileNameAndUuid.toObject, includeInstance)
  };
...
proto.api_container_api.ListFilesArtifactNamesAndUuidsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.api_container_api.FileNameAndUuid;
      reader.readMessage(value,proto.api_container_api.FileNameAndUuid.deserializeBinaryFromReader);
...
proto.api_container_api.ListFilesArtifactNamesAndUuidsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.api_container_api.FileNameAndUuid.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated FileNameAndUuid file_names_and_uuids = 1;
 * @return {!Array<!proto.api_container_api.FileNameAndUuid>}
 */
proto.api_container_api.ListFilesArtifactNamesAndUuidsResponse.prototype.getFileNamesAndUuidsList = function() {
  return /** @type{!Array<!proto.api_container_api.FileNameAndUuid>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api_container_api.FileNameAndUuid, 1));
};


/**
 * @param {!Array<!proto.api_container_api.FileNameAndUuid>} value
...
/**
 * @param {!proto.api_container_api.FileNameAndUuid=} opt_value
 * @param {number=} opt_index
 * @return {!proto.api_container_api.FileNameAndUuid}
 */
proto.api_container_api.ListFilesArtifactNamesAndUuidsResponse.prototype.addFileNamesAndUuids = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.api_container_api.FileNameAndUuid, opt_index);
};
