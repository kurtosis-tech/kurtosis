...
function serialize_portal_daemon_api_ForwardUserServicePortArgs(arg) {
  if (!(arg instanceof portal_client_pb.ForwardUserServicePortArgs)) {
...
function deserialize_portal_daemon_api_ForwardUserServicePortArgs(buffer_arg) {
  return portal_client_pb.ForwardUserServicePortArgs.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_portal_daemon_api_ForwardUserServicePortResponse(arg) {
  if (!(arg instanceof portal_client_pb.ForwardUserServicePortResponse)) {
...
function deserialize_portal_daemon_api_ForwardUserServicePortResponse(buffer_arg) {
  return portal_client_pb.ForwardUserServicePortResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_portal_daemon_api_PortalPing(arg) {
  if (!(arg instanceof portal_client_pb.PortalPing)) {
...
function deserialize_portal_daemon_api_PortalPing(buffer_arg) {
  return portal_client_pb.PortalPing.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_portal_daemon_api_PortalPong(arg) {
  if (!(arg instanceof portal_client_pb.PortalPong)) {
...
function deserialize_portal_daemon_api_PortalPong(buffer_arg) {
  return portal_client_pb.PortalPong.deserializeBinary(new Uint8Array(buffer_arg));
}
...
ping: {
    ...
    requestType: portal_client_pb.PortalPing,
    responseType: portal_client_pb.PortalPong,
  ...
  forwardUserServicePort: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: portal_client_pb.ForwardUserServicePortArgs,
    responseType: portal_client_pb.ForwardUserServicePortResponse,
