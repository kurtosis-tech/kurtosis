...
goog.exportSymbol('proto.engine_api.LogLineFilter.LogLineOperator', null, global);
...
proto.engine_api.GetServiceLogsArgs.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lineFiltersList: jspb.Message.toObjectList(msg.getLineFiltersList(),
...
/**
 * repeated LogLineFilter line_filters = 4;
 * @return {!Array<!proto.engine_api.LogLineFilter>}
 */
proto.engine_api.GetServiceLogsArgs.prototype.getLineFiltersList = function() {
 ...
 * @return {!proto.engine_api.GetServiceLogsArgs} returns this
*/
proto.engine_api.GetServiceLogsArgs.prototype.setLineFiltersList = function(value) {
 ...
 */
proto.engine_api.GetServiceLogsArgs.prototype.addLineFilters = function(opt_value, opt_index) {
 ...
 * @return {!proto.engine_api.GetServiceLogsArgs} returns this
 */
proto.engine_api.GetServiceLogsArgs.prototype.clearLineFiltersList = function() {
  return this.setLineFiltersList([]);
};
...
proto.engine_api.LogLineFilter.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.engine_api.LogLineFilter.LogLineOperator} */ (reader.readEnum());
 ...
 * @return {!proto.engine_api.LogLineFilter.LogLineOperator}
 */
proto.engine_api.LogLineFilter.prototype.getOperator = function() {
  return /** @type {!proto.engine_api.LogLineFilter.LogLineOperator} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.engine_api.LogLineFilter.LogLineOperator} value
