 ...
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.google.protobuf.Empty,
 *   !proto.engine_api.PackageCatalogResponse>}
 */
const methodDescriptor_EngineService_GetPackages = new grpc.web.MethodDescriptor(
  ...
  proto.engine_api.PackageCatalogResponse.deserializeBinary
);
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.engine_api.PackageCatalogResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.engine_api.PackageCatalogResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.engine_api.EngineServiceClient.prototype.getPackages =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/engine_api.EngineService/GetPackages',
      request,
      metadata || {},
      methodDescriptor_EngineService_GetPackages,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.engine_api.PackageCatalogResponse>}
 *     Promise that resolves to the response
 */
proto.engine_api.EngineServicePromiseClient.prototype.getPackages =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/engine_api.EngineService/GetPackages',
      request,
