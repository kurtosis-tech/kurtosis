...
export interface components {
    schemas: {
        ...
        ServiceInfo: {
            ...
            /** @description Whether the service was started with Docker privileged mode. */
            privileged?: boolean;
            /** @description Host-path to container-path bind mounts configured on the service. */
            bind_mounts?: {
                [key: string]: string | undefined;
            };
            /** @description Whether the service was started in the Docker host PID namespace. */
        ...
        RunStarlarkScript: {
            ...
            /** @description Defaults to false */
            parallel?: boolean;
            /** @description Allows Docker-only privileged containers, host bind mounts, and host PID namespace for this run. Defaults to false */
            allow_privileged_mode?: boolean;
        };
        RunStarlarkPackage: {
            /** @description Parameters data for the Starlark package main function */
            params?: {
