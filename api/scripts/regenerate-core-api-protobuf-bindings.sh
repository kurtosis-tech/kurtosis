...
RPC_BINDINGS_DIRNAME="kurtosis_core_rpc_api_bindings"
CORE_DIR_NAME="core"

# =============================== MAIN LOGIC =======================================================
input_dirpath="${api_dirpath}/${PROTOBUF_DIRNAME}/${CORE_DIR_NAME}"

# Golang
go_output_dirpath="${api_dirpath}/${GOLANG_DIRNAME}/${CORE_DIR_NAME}/${RPC_BINDINGS_DIRNAME}"
...
# TypeScript
typescript_output_dirpath="${api_dirpath}/${TYPESCRIPT_DIRNAME}/${CORE_DIR_NAME}/src/${RPC_BINDINGS_DIRNAME}"
