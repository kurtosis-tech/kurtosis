...
type FactRecipe struct {
	...
	RefreshInterval      *durationpb.Duration              `protobuf:"bytes,10,opt,name=refresh_interval,json=refreshInterval,proto3" json:"refresh_interval,omitempty"`
}
...
var file_api_container_service_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x4f, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x46, 0x61, 0x63,
	...
	0x61, 0x63, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x56, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x46, 0x61,
	0x63, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x3d, 0x0a, 0x0b, 0x66, 0x61, 0x63, 0x74, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x70, 0x69, 0x5f, 0x63, 0x6f, 0x6e, 0x74,
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x46, 0x61, 0x63, 0x74, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x52, 0x0a, 0x66, 0x61, 0x63, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22,
	...
	0x09, 0x52, 0x07, 0x63, 0x6d, 0x64, 0x41, 0x72, 0x67, 0x73, 0x22, 0xf3, 0x01, 0x0a, 0x15, 0x48,
	...
	0x64, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x12, 0x30,
	0x0a, 0x14, 0x70, 0x6f, 0x73, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x69, 0x6e,
	0x67, 0x5f, 0x73, 0x74, 0x65, 0x70, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x70, 0x6f,
	0x73, 0x74, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x65, 0x70,
	0x22, 0x90, 0x03, 0x0a, 0x0a, 0x46, 0x61, 0x63, 0x74, 0x52, 0x65, 0x63, 0x69, 0x70, 0x65, 0x12,
	0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x61, 0x63, 0x74, 0x12, 0x44, 0x0a, 0x10, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x69,
	...
	0x68, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x42, 0x18, 0x0a, 0x16, 0x66, 0x61, 0x63,
	0x74, 0x5f, 0x72, 0x65, 0x63, 0x69, 0x70, 0x65, 0x5f, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x22, 0x4d, 0x0a, 0x1a, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x53, 0x74,
...
var file_api_container_service_proto_depIdxs = []int32{
	...
	47, // 26: api_container_api.GetFactValuesResponse.fact_values:type_name -> api_container_api.FactValue
	72, // 27: api_container_api.FactValue.updated_at:type_name -> google.protobuf.Timestamp
	47, // 28: api_container_api.ConstantFactRecipe.fact_value:type_name -> api_container_api.FactValue
	0,  // 29: api_container_api.HttpRequestFactRecipe.method:type_name -> api_container_api.HttpRequestMethod
	48, // 30: api_container_api.FactRecipe.constant_fact:type_name -> api_container_api.ConstantFactRecipe
	49, // 31: api_container_api.FactRecipe.exec_fact:type_name -> api_container_api.ExecFactRecipe
	50, // 32: api_container_api.FactRecipe.http_request_fact:type_name -> api_container_api.HttpRequestFactRecipe
	73, // 33: api_container_api.FactRecipe.refresh_interval:type_name -> google.protobuf.Duration
	2,  // 34: api_container_api.ServiceInfo.PrivatePortsEntry.value:type_name -> api_container_api.Port
	2,  // 35: api_container_api.ServiceInfo.MaybePublicPortsEntry.value:type_name -> api_container_api.Port
	2,  // 36: api_container_api.ServiceConfig.PrivatePortsEntry.value:type_name -> api_container_api.Port
	2,  // 37: api_container_api.ServiceConfig.PublicPortsEntry.value:type_name -> api_container_api.Port
	5,  // 38: api_container_api.GetModulesResponse.ModuleInfoEntry.value:type_name -> api_container_api.ModuleInfo
	4,  // 39: api_container_api.StartServicesArgs.ServiceIdsToConfigsEntry.value:type_name -> api_container_api.ServiceConfig
	3,  // 40: api_container_api.StartServicesResponse.SuccessfulServiceIdsToServiceInfoEntry.value:type_name -> api_container_api.ServiceInfo
	3,  // 41: api_container_api.GetServicesResponse.ServiceInfoEntry.value:type_name -> api_container_api.ServiceInfo
	23, // 42: api_container_api.RepartitionArgs.PartitionServicesEntry.value:type_name -> api_container_api.PartitionServices
	24, // 43: api_container_api.RepartitionArgs.PartitionConnectionsEntry.value:type_name -> api_container_api.PartitionConnections
	25, // 44: api_container_api.PartitionConnections.ConnectionInfoEntry.value:type_name -> api_container_api.PartitionConnectionInfo
	70, // 45: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry.value:type_name -> api_container_api.RenderTemplatesToFilesArtifactArgs.TemplateAndData
	6,  // 46: api_container_api.ApiContainerService.LoadModule:input_type -> api_container_api.LoadModuleArgs
	8,  // 47: api_container_api.ApiContainerService.GetModules:input_type -> api_container_api.GetModulesArgs
	10, // 48: api_container_api.ApiContainerService.UnloadModule:input_type -> api_container_api.UnloadModuleArgs
	12, // 49: api_container_api.ApiContainerService.ExecuteModule:input_type -> api_container_api.ExecuteModuleArgs
	14, // 50: api_container_api.ApiContainerService.ExecuteStartosisScript:input_type -> api_container_api.ExecuteStartosisScriptArgs
	52, // 51: api_container_api.ApiContainerService.ExecuteStartosisModule:input_type -> api_container_api.ExecuteStartosisModuleArgs
	16, // 52: api_container_api.ApiContainerService.StartServices:input_type -> api_container_api.StartServicesArgs
	18, // 53: api_container_api.ApiContainerService.GetServices:input_type -> api_container_api.GetServicesArgs
	20, // 54: api_container_api.ApiContainerService.RemoveService:input_type -> api_container_api.RemoveServiceArgs
	22, // 55: api_container_api.ApiContainerService.Repartition:input_type -> api_container_api.RepartitionArgs
	26, // 56: api_container_api.ApiContainerService.ExecCommand:input_type -> api_container_api.ExecCommandArgs
	43, // 57: api_container_api.ApiContainerService.DefineFact:input_type -> api_container_api.DefineFactArgs
	45, // 58: api_container_api.ApiContainerService.GetFactValues:input_type -> api_container_api.GetFactValuesArgs
	27, // 59: api_container_api.ApiContainerService.PauseService:input_type -> api_container_api.PauseServiceArgs
	28, // 60: api_container_api.ApiContainerService.UnpauseService:input_type -> api_container_api.UnpauseServiceArgs
	30, // 61: api_container_api.ApiContainerService.WaitForHttpGetEndpointAvailability:input_type -> api_container_api.WaitForHttpGetEndpointAvailabilityArgs
	31, // 62: api_container_api.ApiContainerService.WaitForHttpPostEndpointAvailability:input_type -> api_container_api.WaitForHttpPostEndpointAvailabilityArgs
	32, // 63: api_container_api.ApiContainerService.UploadFilesArtifact:input_type -> api_container_api.UploadFilesArtifactArgs
	34, // 64: api_container_api.ApiContainerService.DownloadFilesArtifact:input_type -> api_container_api.DownloadFilesArtifactArgs
	36, // 65: api_container_api.ApiContainerService.StoreWebFilesArtifact:input_type -> api_container_api.StoreWebFilesArtifactArgs
	38, // 66: api_container_api.ApiContainerService.StoreFilesArtifactFromService:input_type -> api_container_api.StoreFilesArtifactFromServiceArgs
	40, // 67: api_container_api.ApiContainerService.RenderTemplatesToFilesArtifact:input_type -> api_container_api.RenderTemplatesToFilesArtifactArgs
	7,  // 68: api_container_api.ApiContainerService.LoadModule:output_type -> api_container_api.LoadModuleResponse
	9,  // 69: api_container_api.ApiContainerService.GetModules:output_type -> api_container_api.GetModulesResponse
	11, // 70: api_container_api.ApiContainerService.UnloadModule:output_type -> api_container_api.UnloadModuleResponse
	13, // 71: api_container_api.ApiContainerService.ExecuteModule:output_type -> api_container_api.ExecuteModuleResponse
	15, // 72: api_container_api.ApiContainerService.ExecuteStartosisScript:output_type -> api_container_api.ExecuteStartosisResponse
	15, // 73: api_container_api.ApiContainerService.ExecuteStartosisModule:output_type -> api_container_api.ExecuteStartosisResponse
	17, // 74: api_container_api.ApiContainerService.StartServices:output_type -> api_container_api.StartServicesResponse
	19, // 75: api_container_api.ApiContainerService.GetServices:output_type -> api_container_api.GetServicesResponse
	21, // 76: api_container_api.ApiContainerService.RemoveService:output_type -> api_container_api.RemoveServiceResponse
	74, // 77: api_container_api.ApiContainerService.Repartition:output_type -> google.protobuf.Empty
	29, // 78: api_container_api.ApiContainerService.ExecCommand:output_type -> api_container_api.ExecCommandResponse
	44, // 79: api_container_api.ApiContainerService.DefineFact:output_type -> api_container_api.DefineFactResponse
	46, // 80: api_container_api.ApiContainerService.GetFactValues:output_type -> api_container_api.GetFactValuesResponse
	74, // 81: api_container_api.ApiContainerService.PauseService:output_type -> google.protobuf.Empty
	74, // 82: api_container_api.ApiContainerService.UnpauseService:output_type -> google.protobuf.Empty
	74, // 83: api_container_api.ApiContainerService.WaitForHttpGetEndpointAvailability:output_type -> google.protobuf.Empty
	74, // 84: api_container_api.ApiContainerService.WaitForHttpPostEndpointAvailability:output_type -> google.protobuf.Empty
	33, // 85: api_container_api.ApiContainerService.UploadFilesArtifact:output_type -> api_container_api.UploadFilesArtifactResponse
	35, // 86: api_container_api.ApiContainerService.DownloadFilesArtifact:output_type -> api_container_api.DownloadFilesArtifactResponse
	37, // 87: api_container_api.ApiContainerService.StoreWebFilesArtifact:output_type -> api_container_api.StoreWebFilesArtifactResponse
	39, // 88: api_container_api.ApiContainerService.StoreFilesArtifactFromService:output_type -> api_container_api.StoreFilesArtifactFromServiceResponse
	41, // 89: api_container_api.ApiContainerService.RenderTemplatesToFilesArtifact:output_type -> api_container_api.RenderTemplatesToFilesArtifactResponse
