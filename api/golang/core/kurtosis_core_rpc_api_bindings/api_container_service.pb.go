...
type ServiceInfo struct {
	...
	// Whether the service was started in the Docker host cgroup namespace.
	HostCgroupNamespace bool `protobuf:"varint,29,opt,name=host_cgroup_namespace,json=hostCgroupNamespace,proto3" json:"host_cgroup_namespace,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ServiceInfo) GetHostCgroupNamespace() bool {
	if x != nil {
		return x.HostCgroupNamespace
	}
	return false
}
...
const file_api_container_service_proto_rawDesc = "" +
	...
	"\x12toleration_seconds\x18\x05 \x01(\x03R\x11tolerationSeconds\"\xce\x10\n" +
	"\vServiceInfo\x12!\n" +
	...
	"bindMounts\x12,\n" +
	"\x12host_pid_namespace\x18\x1c \x01(\bR\x10hostPidNamespace\x122\n" +
	"\x15host_cgroup_namespace\x18\x1d \x01(\bR\x13hostCgroupNamespace\x1aX\n" +
