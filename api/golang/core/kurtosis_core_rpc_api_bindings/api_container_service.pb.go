...
func (x *InspectFilesArtifactContentsRequest) GetFilePath() string {
...
type FileArtifactContentsFileDescription struct {
	...
	Description string  `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`                          // One-liner description of the file (similar to UNIX's 'file')
	TextPreview *string `protobuf:"bytes,3,opt,name=text_preview,json=textPreview,proto3,oneof" json:"text_preview,omitempty"` // A bit of text content, if the file allows (similar to UNIX's 'head')
}
...
func (x *FileArtifactContentsFileDescription) GetDescription() string {
	if x != nil {
...
var file_api_container_service_proto_rawDesc = []byte{
	...
	0x41, 0x6e, 0x64, 0x55, 0x75, 0x69, 0x64, 0x73, 0x22, 0xb1, 0x01, 0x0a, 0x23, 0x49, 0x6e, 0x73,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x73, 0x41, 0x6e, 0x64, 0x55, 0x75, 0x69, 0x64, 0x12, 0x20, 0x0a, 0x09,
	0x66, 0x69, 0x6c, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48,
	0x00, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x88, 0x01, 0x01, 0x42, 0x0c,
	0x0a, 0x0a, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x22, 0x8b, 0x01, 0x0a,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x94, 0x01, 0x0a, 0x23, 0x46,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x0a, 0x0c, 0x74, 0x65, 0x78, 0x74,
	...
	0x77, 0x2a, 0x32, 0x0a, 0x13, 0x4b, 0x75, 0x72, 0x74, 0x6f, 0x73, 0x69, 0x73, 0x46, 0x65, 0x61,
	...
	0x49, 0x4e, 0x47, 0x10, 0x00, 0x32, 0x8e, 0x0d, 0x0a, 0x13, 0x41, 0x70, 0x69, 0x43, 0x6f, 0x6e,
...
func file_api_container_service_proto_init() {
	...
	file_api_container_service_proto_msgTypes[35].OneofWrappers = []interface{}{}
