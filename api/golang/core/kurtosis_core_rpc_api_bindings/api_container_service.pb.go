...
func (*RenderTemplatesToFilesArtifactArgs_TemplateAndData) Descriptor() ([]byte, []int) {
	return file_api_container_service_proto_rawDescGZIP(), []int{40, 0}
}
...
var file_api_container_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x55, 0x75, 0x69, 0x64, 0x22, 0x63, 0x0a, 0x0f, 0x45,
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x41, 0x0a, 0x17, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	...
	0x55, 0x75, 0x69, 0x64, 0x73, 0x32, 0xc5, 0x10, 0x0a, 0x13, 0x41, 0x70, 0x69, 0x43, 0x6f, 0x6e,
	...
	0x4c, 0x69, 0x6e, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x5b, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x22, 0x2e, 0x61, 0x70, 0x69, 0x5f, 0x63, 0x6f,
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x64, 0x64, 0x53,
	...
	0x71, 0x0a, 0x15, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x41, 0x72,
	0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x56, 0x32, 0x12, 0x24, 0x2e, 0x61, 0x70, 0x69, 0x5f, 0x63,
	...
	0x28, 0x01, 0x12, 0x79, 0x0a, 0x15, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x46, 0x69,
...
var file_api_container_service_proto_goTypes = []interface{}{
	...
	(*ExecCommandArgs)(nil),                                    // 27: api_container_api.ExecCommandArgs
	...
	(*StreamedDataChunk)(nil),                                  // 31: api_container_api.StreamedDataChunk
	(*DataChunkMetadata)(nil),                                  // 32: api_container_api.DataChunkMetadata
	(*UploadFilesArtifactArgs)(nil),                            // 33: api_container_api.UploadFilesArtifactArgs
	...
	(*DownloadFilesArtifactResponse)(nil),                      // 36: api_container_api.DownloadFilesArtifactResponse
	...
	(*RenderTemplatesToFilesArtifactArgs)(nil),                 // 41: api_container_api.RenderTemplatesToFilesArtifactArgs
	(*RenderTemplatesToFilesArtifactResponse)(nil),             // 42: api_container_api.RenderTemplatesToFilesArtifactResponse
	(*FilesArtifactNameAndUuid)(nil),                           // 43: api_container_api.FilesArtifactNameAndUuid
	(*ListFilesArtifactNamesAndUuidsResponse)(nil),             // 44: api_container_api.ListFilesArtifactNamesAndUuidsResponse
	nil, // 45: api_container_api.ServiceInfo.PrivatePortsEntry
	nil, // 46: api_container_api.ServiceInfo.MaybePublicPortsEntry
	nil, // 47: api_container_api.ServiceConfig.PrivatePortsEntry
	nil, // 48: api_container_api.ServiceConfig.PublicPortsEntry
	nil, // 49: api_container_api.ServiceConfig.EnvVarsEntry
	nil, // 50: api_container_api.ServiceConfig.FilesArtifactMountpointsEntry
	nil, // 51: api_container_api.AddServicesArgs.ServiceNamesToConfigsEntry
	nil, // 52: api_container_api.AddServicesResponse.SuccessfulServiceNameToServiceInfoEntry
	nil, // 53: api_container_api.AddServicesResponse.FailedServiceNameToErrorEntry
	nil, // 54: api_container_api.GetServicesArgs.ServiceIdentifiersEntry
	nil, // 55: api_container_api.GetServicesResponse.ServiceInfoEntry
	(*RenderTemplatesToFilesArtifactArgs_TemplateAndData)(nil), // 56: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplateAndData
	nil,                   // 57: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry
...
var file_api_container_service_proto_depIdxs = []int32{
	...
	45, // 1: api_container_api.ServiceInfo.private_ports:type_name -> api_container_api.ServiceInfo.PrivatePortsEntry
	46, // 2: api_container_api.ServiceInfo.maybe_public_ports:type_name -> api_container_api.ServiceInfo.MaybePublicPortsEntry
	47, // 3: api_container_api.ServiceConfig.private_ports:type_name -> api_container_api.ServiceConfig.PrivatePortsEntry
	48, // 4: api_container_api.ServiceConfig.public_ports:type_name -> api_container_api.ServiceConfig.PublicPortsEntry
	49, // 5: api_container_api.ServiceConfig.env_vars:type_name -> api_container_api.ServiceConfig.EnvVarsEntry
	50, // 6: api_container_api.ServiceConfig.files_artifact_mountpoints:type_name -> api_container_api.ServiceConfig.FilesArtifactMountpointsEntry
	...
	51, // 18: api_container_api.AddServicesArgs.service_names_to_configs:type_name -> api_container_api.AddServicesArgs.ServiceNamesToConfigsEntry
	52, // 19: api_container_api.AddServicesResponse.successful_service_name_to_service_info:type_name -> api_container_api.AddServicesResponse.SuccessfulServiceNameToServiceInfoEntry
	53, // 20: api_container_api.AddServicesResponse.failed_service_name_to_error:type_name -> api_container_api.AddServicesResponse.FailedServiceNameToErrorEntry
	54, // 21: api_container_api.GetServicesArgs.service_identifiers:type_name -> api_container_api.GetServicesArgs.ServiceIdentifiersEntry
	55, // 22: api_container_api.GetServicesResponse.service_info:type_name -> api_container_api.GetServicesResponse.ServiceInfoEntry
	...
	32, // 24: api_container_api.StreamedDataChunk.metadata:type_name -> api_container_api.DataChunkMetadata
	57, // 25: api_container_api.RenderTemplatesToFilesArtifactArgs.templates_and_data_by_destination_rel_filepath:type_name -> api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry
	43, // 26: api_container_api.ListFilesArtifactNamesAndUuidsResponse.file_names_and_uuids:type_name -> api_container_api.FilesArtifactNameAndUuid
	...
	3,  // 31: api_container_api.AddServicesArgs.ServiceNamesToConfigsEntry.value:type_name -> api_container_api.ServiceConfig
	2,  // 32: api_container_api.AddServicesResponse.SuccessfulServiceNameToServiceInfoEntry.value:type_name -> api_container_api.ServiceInfo
	2,  // 33: api_container_api.GetServicesResponse.ServiceInfoEntry.value:type_name -> api_container_api.ServiceInfo
	56, // 34: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry.value:type_name -> api_container_api.RenderTemplatesToFilesArtifactArgs.TemplateAndData
	5,  // 35: api_container_api.ApiContainerService.RunStarlarkScript:input_type -> api_container_api.RunStarlarkScriptArgs
	31, // 36: api_container_api.ApiContainerService.UploadStarlarkPackage:input_type -> api_container_api.StreamedDataChunk
	6,  // 37: api_container_api.ApiContainerService.RunStarlarkPackage:input_type -> api_container_api.RunStarlarkPackageArgs
	19, // 38: api_container_api.ApiContainerService.AddServices:input_type -> api_container_api.AddServicesArgs
	21, // 39: api_container_api.ApiContainerService.GetServices:input_type -> api_container_api.GetServicesArgs
	58, // 40: api_container_api.ApiContainerService.GetExistingAndHistoricalServiceIdentifiers:input_type -> google.protobuf.Empty
	25, // 41: api_container_api.ApiContainerService.RemoveService:input_type -> api_container_api.RemoveServiceArgs
	27, // 42: api_container_api.ApiContainerService.ExecCommand:input_type -> api_container_api.ExecCommandArgs
	29, // 43: api_container_api.ApiContainerService.WaitForHttpGetEndpointAvailability:input_type -> api_container_api.WaitForHttpGetEndpointAvailabilityArgs
	30, // 44: api_container_api.ApiContainerService.WaitForHttpPostEndpointAvailability:input_type -> api_container_api.WaitForHttpPostEndpointAvailabilityArgs
	33, // 45: api_container_api.ApiContainerService.UploadFilesArtifact:input_type -> api_container_api.UploadFilesArtifactArgs
	31, // 46: api_container_api.ApiContainerService.UploadFilesArtifactV2:input_type -> api_container_api.StreamedDataChunk
	35, // 47: api_container_api.ApiContainerService.DownloadFilesArtifact:input_type -> api_container_api.DownloadFilesArtifactArgs
	35, // 48: api_container_api.ApiContainerService.DownloadFilesArtifactV2:input_type -> api_container_api.DownloadFilesArtifactArgs
	37, // 49: api_container_api.ApiContainerService.StoreWebFilesArtifact:input_type -> api_container_api.StoreWebFilesArtifactArgs
	39, // 50: api_container_api.ApiContainerService.StoreFilesArtifactFromService:input_type -> api_container_api.StoreFilesArtifactFromServiceArgs
	41, // 51: api_container_api.ApiContainerService.RenderTemplatesToFilesArtifact:input_type -> api_container_api.RenderTemplatesToFilesArtifactArgs
	58, // 52: api_container_api.ApiContainerService.ListFilesArtifactNamesAndUuids:input_type -> google.protobuf.Empty
	7,  // 53: api_container_api.ApiContainerService.RunStarlarkScript:output_type -> api_container_api.StarlarkRunResponseLine
	58, // 54: api_container_api.ApiContainerService.UploadStarlarkPackage:output_type -> google.protobuf.Empty
	7,  // 55: api_container_api.ApiContainerService.RunStarlarkPackage:output_type -> api_container_api.StarlarkRunResponseLine
	20, // 56: api_container_api.ApiContainerService.AddServices:output_type -> api_container_api.AddServicesResponse
	22, // 57: api_container_api.ApiContainerService.GetServices:output_type -> api_container_api.GetServicesResponse
	24, // 58: api_container_api.ApiContainerService.GetExistingAndHistoricalServiceIdentifiers:output_type -> api_container_api.GetExistingAndHistoricalServiceIdentifiersResponse
	26, // 59: api_container_api.ApiContainerService.RemoveService:output_type -> api_container_api.RemoveServiceResponse
	28, // 60: api_container_api.ApiContainerService.ExecCommand:output_type -> api_container_api.ExecCommandResponse
	...
	34, // 63: api_container_api.ApiContainerService.UploadFilesArtifact:output_type -> api_container_api.UploadFilesArtifactResponse
	34, // 64: api_container_api.ApiContainerService.UploadFilesArtifactV2:output_type -> api_container_api.UploadFilesArtifactResponse
	36, // 65: api_container_api.ApiContainerService.DownloadFilesArtifact:output_type -> api_container_api.DownloadFilesArtifactResponse
	31, // 66: api_container_api.ApiContainerService.DownloadFilesArtifactV2:output_type -> api_container_api.StreamedDataChunk
	38, // 67: api_container_api.ApiContainerService.StoreWebFilesArtifact:output_type -> api_container_api.StoreWebFilesArtifactResponse
	40, // 68: api_container_api.ApiContainerService.StoreFilesArtifactFromService:output_type -> api_container_api.StoreFilesArtifactFromServiceResponse
	42, // 69: api_container_api.ApiContainerService.RenderTemplatesToFilesArtifact:output_type -> api_container_api.RenderTemplatesToFilesArtifactResponse
	44, // 70: api_container_api.ApiContainerService.ListFilesArtifactNamesAndUuids:output_type -> api_container_api.ListFilesArtifactNamesAndUuidsResponse
