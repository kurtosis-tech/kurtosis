...
var file_api_container_service_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x4d, 0x0a,
	0x1a, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x53, 0x74, 0x61, 0x72, 0x74, 0x6f, 0x73, 0x69,
	0x73, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x41, 0x72, 0x67, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x6d,
	0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xf9, 0x10, 0x0a,
...
var file_api_container_service_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_api_container_service_proto_goTypes = []interface{}{
	...
	nil,                                             // 51: api_container_api.StartServicesArgs.ServiceIdsToConfigsEntry
	nil,                                             // 52: api_container_api.StartServicesResponse.SuccessfulServiceIdsToServiceInfoEntry
	nil,                                             // 53: api_container_api.StartServicesResponse.FailedServiceIdsToErrorEntry
	nil,                                             // 54: api_container_api.GetServicesArgs.ServiceIdsEntry
	nil,                                             // 55: api_container_api.GetServicesResponse.ServiceInfoEntry
	nil,                                             // 56: api_container_api.RepartitionArgs.PartitionServicesEntry
	nil,                                             // 57: api_container_api.RepartitionArgs.PartitionConnectionsEntry
	nil,                                             // 58: api_container_api.PartitionServices.ServiceIdSetEntry
	nil,                                             // 59: api_container_api.PartitionConnections.ConnectionInfoEntry
	(*RenderTemplatesToFilesArtifactArgs_TemplateAndData)(nil), // 60: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplateAndData
	nil,                   // 61: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry
...
var file_api_container_service_proto_depIdxs = []int32{
	...
	51, // 14: api_container_api.StartServicesArgs.service_ids_to_configs:type_name -> api_container_api.StartServicesArgs.ServiceIdsToConfigsEntry
	52, // 15: api_container_api.StartServicesResponse.successful_service_ids_to_service_info:type_name -> api_container_api.StartServicesResponse.SuccessfulServiceIdsToServiceInfoEntry
	53, // 16: api_container_api.StartServicesResponse.failed_service_ids_to_error:type_name -> api_container_api.StartServicesResponse.FailedServiceIdsToErrorEntry
	54, // 17: api_container_api.GetServicesArgs.service_ids:type_name -> api_container_api.GetServicesArgs.ServiceIdsEntry
	55, // 18: api_container_api.GetServicesResponse.service_info:type_name -> api_container_api.GetServicesResponse.ServiceInfoEntry
	56, // 19: api_container_api.RepartitionArgs.partition_services:type_name -> api_container_api.RepartitionArgs.PartitionServicesEntry
	57, // 20: api_container_api.RepartitionArgs.partition_connections:type_name -> api_container_api.RepartitionArgs.PartitionConnectionsEntry
	24, // 21: api_container_api.RepartitionArgs.default_connection:type_name -> api_container_api.PartitionConnectionInfo
	58, // 22: api_container_api.PartitionServices.service_id_set:type_name -> api_container_api.PartitionServices.ServiceIdSetEntry
	59, // 23: api_container_api.PartitionConnections.connection_info:type_name -> api_container_api.PartitionConnections.ConnectionInfoEntry
	61, // 24: api_container_api.RenderTemplatesToFilesArtifactArgs.templates_and_data_by_destination_rel_filepath:type_name -> api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry
	1,  // 25: api_container_api.ServiceInfo.PrivatePortsEntry.value:type_name -> api_container_api.Port
	1,  // 26: api_container_api.ServiceInfo.MaybePublicPortsEntry.value:type_name -> api_container_api.Port
	1,  // 27: api_container_api.ServiceConfig.PrivatePortsEntry.value:type_name -> api_container_api.Port
	1,  // 28: api_container_api.ServiceConfig.PublicPortsEntry.value:type_name -> api_container_api.Port
	4,  // 29: api_container_api.GetModulesResponse.ModuleInfoEntry.value:type_name -> api_container_api.ModuleInfo
	3,  // 30: api_container_api.StartServicesArgs.ServiceIdsToConfigsEntry.value:type_name -> api_container_api.ServiceConfig
	2,  // 31: api_container_api.StartServicesResponse.SuccessfulServiceIdsToServiceInfoEntry.value:type_name -> api_container_api.ServiceInfo
	2,  // 32: api_container_api.GetServicesResponse.ServiceInfoEntry.value:type_name -> api_container_api.ServiceInfo
	22, // 33: api_container_api.RepartitionArgs.PartitionServicesEntry.value:type_name -> api_container_api.PartitionServices
	23, // 34: api_container_api.RepartitionArgs.PartitionConnectionsEntry.value:type_name -> api_container_api.PartitionConnections
	24, // 35: api_container_api.PartitionConnections.ConnectionInfoEntry.value:type_name -> api_container_api.PartitionConnectionInfo
	60, // 36: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry.value:type_name -> api_container_api.RenderTemplatesToFilesArtifactArgs.TemplateAndData
	5,  // 37: api_container_api.ApiContainerService.LoadModule:input_type -> api_container_api.LoadModuleArgs
	7,  // 38: api_container_api.ApiContainerService.GetModules:input_type -> api_container_api.GetModulesArgs
	9,  // 39: api_container_api.ApiContainerService.UnloadModule:input_type -> api_container_api.UnloadModuleArgs
	11, // 40: api_container_api.ApiContainerService.ExecuteModule:input_type -> api_container_api.ExecuteModuleArgs
	13, // 41: api_container_api.ApiContainerService.ExecuteStartosisScript:input_type -> api_container_api.ExecuteStartosisScriptArgs
	42, // 42: api_container_api.ApiContainerService.ExecuteStartosisModule:input_type -> api_container_api.ExecuteStartosisModuleArgs
	15, // 43: api_container_api.ApiContainerService.StartServices:input_type -> api_container_api.StartServicesArgs
	17, // 44: api_container_api.ApiContainerService.GetServices:input_type -> api_container_api.GetServicesArgs
	19, // 45: api_container_api.ApiContainerService.RemoveService:input_type -> api_container_api.RemoveServiceArgs
	21, // 46: api_container_api.ApiContainerService.Repartition:input_type -> api_container_api.RepartitionArgs
	25, // 47: api_container_api.ApiContainerService.ExecCommand:input_type -> api_container_api.ExecCommandArgs
	26, // 48: api_container_api.ApiContainerService.PauseService:input_type -> api_container_api.PauseServiceArgs
	27, // 49: api_container_api.ApiContainerService.UnpauseService:input_type -> api_container_api.UnpauseServiceArgs
	29, // 50: api_container_api.ApiContainerService.WaitForHttpGetEndpointAvailability:input_type -> api_container_api.WaitForHttpGetEndpointAvailabilityArgs
	30, // 51: api_container_api.ApiContainerService.WaitForHttpPostEndpointAvailability:input_type -> api_container_api.WaitForHttpPostEndpointAvailabilityArgs
	31, // 52: api_container_api.ApiContainerService.UploadFilesArtifact:input_type -> api_container_api.UploadFilesArtifactArgs
	33, // 53: api_container_api.ApiContainerService.DownloadFilesArtifact:input_type -> api_container_api.DownloadFilesArtifactArgs
	35, // 54: api_container_api.ApiContainerService.StoreWebFilesArtifact:input_type -> api_container_api.StoreWebFilesArtifactArgs
	37, // 55: api_container_api.ApiContainerService.StoreFilesArtifactFromService:input_type -> api_container_api.StoreFilesArtifactFromServiceArgs
	39, // 56: api_container_api.ApiContainerService.RenderTemplatesToFilesArtifact:input_type -> api_container_api.RenderTemplatesToFilesArtifactArgs
	6,  // 57: api_container_api.ApiContainerService.LoadModule:output_type -> api_container_api.LoadModuleResponse
	8,  // 58: api_container_api.ApiContainerService.GetModules:output_type -> api_container_api.GetModulesResponse
	10, // 59: api_container_api.ApiContainerService.UnloadModule:output_type -> api_container_api.UnloadModuleResponse
	12, // 60: api_container_api.ApiContainerService.ExecuteModule:output_type -> api_container_api.ExecuteModuleResponse
	14, // 61: api_container_api.ApiContainerService.ExecuteStartosisScript:output_type -> api_container_api.ExecuteStartosisResponse
	14, // 62: api_container_api.ApiContainerService.ExecuteStartosisModule:output_type -> api_container_api.ExecuteStartosisResponse
	...
	62, // 66: api_container_api.ApiContainerService.Repartition:output_type -> google.protobuf.Empty
	28, // 67: api_container_api.ApiContainerService.ExecCommand:output_type -> api_container_api.ExecCommandResponse
	62, // 68: api_container_api.ApiContainerService.PauseService:output_type -> google.protobuf.Empty
	62, // 69: api_container_api.ApiContainerService.UnpauseService:output_type -> google.protobuf.Empty
	62, // 70: api_container_api.ApiContainerService.WaitForHttpGetEndpointAvailability:output_type -> google.protobuf.Empty
	62, // 71: api_container_api.ApiContainerService.WaitForHttpPostEndpointAvailability:output_type -> google.protobuf.Empty
