...
type ExecuteStartosisScriptResponse struct {
	...
	ValidationError        string `protobuf:"bytes,3,opt,name=validation_error,json=validationError,proto3" json:"validation_error,omitempty"` // TODO(gb): no validation for now, but will be in the future
...
func (x *ExecuteStartosisScriptResponse) GetValidationError() string {
	if x != nil {
...
var file_api_container_service_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x7a, 0x65, 0x64, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x22, 0xe1, 0x01, 0x0a, 0x1e,
	...
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x29, 0x0a, 0x10, 0x76,
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x27, 0x0a, 0x0f, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x22,
	...
	0x69, 0x64, 0x32, 0x87, 0x10, 0x0a, 0x13, 0x41, 0x70, 0x69, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69,
	...
	0x00, 0x12, 0x7c, 0x0a, 0x16, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x53, 0x74, 0x61, 0x72,
	0x74, 0x6f, 0x73, 0x69, 0x73, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x12, 0x2d, 0x2e, 0x61, 0x70,
	0x69, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x5f, 0x61, 0x70, 0x69, 0x2e,
	0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x53, 0x74, 0x61, 0x72, 0x74, 0x6f, 0x73, 0x69, 0x73,
	0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x41, 0x72, 0x67, 0x73, 0x1a, 0x31, 0x2e, 0x61, 0x70, 0x69,
...
var file_api_container_service_proto_goTypes = []interface{}{
	...
	nil, // 49: api_container_api.StartServicesArgs.ServiceIdsToConfigsEntry
	nil, // 50: api_container_api.StartServicesResponse.SuccessfulServiceIdsToServiceInfoEntry
	nil, // 51: api_container_api.StartServicesResponse.FailedServiceIdsToErrorEntry
	nil, // 52: api_container_api.GetServicesArgs.ServiceIdsEntry
	nil, // 53: api_container_api.GetServicesResponse.ServiceInfoEntry
	nil, // 54: api_container_api.RepartitionArgs.PartitionServicesEntry
	nil, // 55: api_container_api.RepartitionArgs.PartitionConnectionsEntry
	nil, // 56: api_container_api.PartitionServices.ServiceIdSetEntry
	nil, // 57: api_container_api.PartitionConnections.ConnectionInfoEntry
	(*RenderTemplatesToFilesArtifactArgs_TemplateAndData)(nil), // 58: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplateAndData
	nil,                   // 59: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry
...
var file_api_container_service_proto_depIdxs = []int32{
	...
	49, // 13: api_container_api.StartServicesArgs.service_ids_to_configs:type_name -> api_container_api.StartServicesArgs.ServiceIdsToConfigsEntry
	50, // 14: api_container_api.StartServicesResponse.successful_service_ids_to_service_info:type_name -> api_container_api.StartServicesResponse.SuccessfulServiceIdsToServiceInfoEntry
	51, // 15: api_container_api.StartServicesResponse.failed_service_ids_to_error:type_name -> api_container_api.StartServicesResponse.FailedServiceIdsToErrorEntry
	52, // 16: api_container_api.GetServicesArgs.service_ids:type_name -> api_container_api.GetServicesArgs.ServiceIdsEntry
	53, // 17: api_container_api.GetServicesResponse.service_info:type_name -> api_container_api.GetServicesResponse.ServiceInfoEntry
	54, // 18: api_container_api.RepartitionArgs.partition_services:type_name -> api_container_api.RepartitionArgs.PartitionServicesEntry
	55, // 19: api_container_api.RepartitionArgs.partition_connections:type_name -> api_container_api.RepartitionArgs.PartitionConnectionsEntry
	24, // 20: api_container_api.RepartitionArgs.default_connection:type_name -> api_container_api.PartitionConnectionInfo
	56, // 21: api_container_api.PartitionServices.service_id_set:type_name -> api_container_api.PartitionServices.ServiceIdSetEntry
	57, // 22: api_container_api.PartitionConnections.connection_info:type_name -> api_container_api.PartitionConnections.ConnectionInfoEntry
	59, // 23: api_container_api.RenderTemplatesToFilesArtifactArgs.templates_and_data_by_destination_rel_filepath:type_name -> api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry
	...
	22, // 32: api_container_api.RepartitionArgs.PartitionServicesEntry.value:type_name -> api_container_api.PartitionServices
	23, // 33: api_container_api.RepartitionArgs.PartitionConnectionsEntry.value:type_name -> api_container_api.PartitionConnections
	24, // 34: api_container_api.PartitionConnections.ConnectionInfoEntry.value:type_name -> api_container_api.PartitionConnectionInfo
	58, // 35: api_container_api.RenderTemplatesToFilesArtifactArgs.TemplatesAndDataByDestinationRelFilepathEntry.value:type_name -> api_container_api.RenderTemplatesToFilesArtifactArgs.TemplateAndData
	...
	13, // 40: api_container_api.ApiContainerService.ExecuteStartosisScript:input_type -> api_container_api.ExecuteStartosisScriptArgs
	15, // 41: api_container_api.ApiContainerService.StartServices:input_type -> api_container_api.StartServicesArgs
	17, // 42: api_container_api.ApiContainerService.GetServices:input_type -> api_container_api.GetServicesArgs
	19, // 43: api_container_api.ApiContainerService.RemoveService:input_type -> api_container_api.RemoveServiceArgs
	21, // 44: api_container_api.ApiContainerService.Repartition:input_type -> api_container_api.RepartitionArgs
	25, // 45: api_container_api.ApiContainerService.ExecCommand:input_type -> api_container_api.ExecCommandArgs
	26, // 46: api_container_api.ApiContainerService.PauseService:input_type -> api_container_api.PauseServiceArgs
	27, // 47: api_container_api.ApiContainerService.UnpauseService:input_type -> api_container_api.UnpauseServiceArgs
	29, // 48: api_container_api.ApiContainerService.WaitForHttpGetEndpointAvailability:input_type -> api_container_api.WaitForHttpGetEndpointAvailabilityArgs
	30, // 49: api_container_api.ApiContainerService.WaitForHttpPostEndpointAvailability:input_type -> api_container_api.WaitForHttpPostEndpointAvailabilityArgs
	31, // 50: api_container_api.ApiContainerService.UploadFilesArtifact:input_type -> api_container_api.UploadFilesArtifactArgs
	33, // 51: api_container_api.ApiContainerService.DownloadFilesArtifact:input_type -> api_container_api.DownloadFilesArtifactArgs
	35, // 52: api_container_api.ApiContainerService.StoreWebFilesArtifact:input_type -> api_container_api.StoreWebFilesArtifactArgs
	37, // 53: api_container_api.ApiContainerService.StoreFilesArtifactFromService:input_type -> api_container_api.StoreFilesArtifactFromServiceArgs
	39, // 54: api_container_api.ApiContainerService.RenderTemplatesToFilesArtifact:input_type -> api_container_api.RenderTemplatesToFilesArtifactArgs
	6,  // 55: api_container_api.ApiContainerService.LoadModule:output_type -> api_container_api.LoadModuleResponse
	8,  // 56: api_container_api.ApiContainerService.GetModules:output_type -> api_container_api.GetModulesResponse
	10, // 57: api_container_api.ApiContainerService.UnloadModule:output_type -> api_container_api.UnloadModuleResponse
	12, // 58: api_container_api.ApiContainerService.ExecuteModule:output_type -> api_container_api.ExecuteModuleResponse
	14, // 59: api_container_api.ApiContainerService.ExecuteStartosisScript:output_type -> api_container_api.ExecuteStartosisScriptResponse
	16, // 60: api_container_api.ApiContainerService.StartServices:output_type -> api_container_api.StartServicesResponse
	18, // 61: api_container_api.ApiContainerService.GetServices:output_type -> api_container_api.GetServicesResponse
	20, // 62: api_container_api.ApiContainerService.RemoveService:output_type -> api_container_api.RemoveServiceResponse
	60, // 63: api_container_api.ApiContainerService.Repartition:output_type -> google.protobuf.Empty
	28, // 64: api_container_api.ApiContainerService.ExecCommand:output_type -> api_container_api.ExecCommandResponse
	60, // 65: api_container_api.ApiContainerService.PauseService:output_type -> google.protobuf.Empty
	60, // 66: api_container_api.ApiContainerService.UnpauseService:output_type -> google.protobuf.Empty
	60, // 67: api_container_api.ApiContainerService.WaitForHttpGetEndpointAvailability:output_type -> google.protobuf.Empty
	60, // 68: api_container_api.ApiContainerService.WaitForHttpPostEndpointAvailability:output_type -> google.protobuf.Empty
	32, // 69: api_container_api.ApiContainerService.UploadFilesArtifact:output_type -> api_container_api.UploadFilesArtifactResponse
	34, // 70: api_container_api.ApiContainerService.DownloadFilesArtifact:output_type -> api_container_api.DownloadFilesArtifactResponse
	36, // 71: api_container_api.ApiContainerService.StoreWebFilesArtifact:output_type -> api_container_api.StoreWebFilesArtifactResponse
	38, // 72: api_container_api.ApiContainerService.StoreFilesArtifactFromService:output_type -> api_container_api.StoreFilesArtifactFromServiceResponse
	40, // 73: api_container_api.ApiContainerService.RenderTemplatesToFilesArtifact:output_type -> api_container_api.RenderTemplatesToFilesArtifactResponse
