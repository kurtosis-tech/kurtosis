...
func (x *apiContainerServiceUploadFilesArtifactV2Client) Send(m *FileArtifactChunk) error {
...
func (x *apiContainerServiceUploadFilesArtifactV2Server) Recv() (*FileArtifactChunk, error) {
	m := new(FileArtifactChunk)
