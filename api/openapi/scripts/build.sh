...
oapi-codegen --config="$api_root_dirpath/websocket/types.cfg.yaml" "$api_root_dirpath/websocket/websocket_service.yaml"
...
oapi-codegen --config="$api_root_dirpath/websocket/server.cfg.yaml" "$api_root_dirpath/websocket/websocket_service.yaml"