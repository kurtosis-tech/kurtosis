...
oapi-codegen --config="$api_root_dirpath/logging/types.cfg.yaml" "$api_root_dirpath/logging/logging_service.yaml"
...
oapi-codegen --config="$api_root_dirpath/logging/server.cfg.yaml" "$api_root_dirpath/logging/logging_service.yaml"