...
import (
	generated "github.com/kurtosis-tech/kurtosis/context-config-store/api/golang/generated"
...
func (_m *MockConfigPersistence) LoadContextConfig() (*generated.KurtosisContextsConfig, error) {
	ret := _m.Called()
...
func (_c *MockConfigPersistence_LoadContextConfig_Call) Return(_a0 *generated.KurtosisContextsConfig, _a1 error) *MockConfigPersistence_LoadContextConfig_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConfigPersistence_LoadContextConfig_Call) RunAndReturn(run func() (*generated.KurtosisContextsConfig, error)) *MockConfigPersistence_LoadContextConfig_Call {
	_c.Call.Return(run)
	return _c
}

// PersistContextConfig provides a mock function with given fields: contextConfig
func (_m *MockConfigPersistence) PersistContextConfig(contextConfig *generated.KurtosisContextsConfig) error {
...
func (_c *MockConfigPersistence_PersistContextConfig_Call) Run(run func(contextConfig *generated.KurtosisContextsConfig)) *MockConfigPersistence_PersistContextConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockConfigPersistence_PersistContextConfig_Call) RunAndReturn(run func(*generated.KurtosisContextsConfig) error) *MockConfigPersistence_PersistContextConfig_Call {
	_c.Call.Return(run)
	return _c
}
