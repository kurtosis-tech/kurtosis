...
const (
	...
	expectedCustomUserLabelKeyPrefixStr = expectedLabelNamespaceStr + "custom."
)
...
var crossVersionLabelKeyStringsToEnsure = map[string]string{
	...
	customUserLabelsKeyPrefixStr: expectedCustomUserLabelKeyPrefixStr,
}

// These are the publicly accessible keys that correspond to the private string constants. They need to stay the same.
var crossVersionLabelKeysToEnsure = map[*DockerLabelKey]string{
