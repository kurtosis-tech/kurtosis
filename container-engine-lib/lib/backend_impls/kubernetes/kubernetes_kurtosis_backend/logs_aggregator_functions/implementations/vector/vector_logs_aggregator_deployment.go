...
func (logsAggregator *vectorLogsAggregatorResourcesManager) CreateAndStart(
	...
	*apiv1.ConfigMap,
	...
	vectorConfigurationCreatorObj := createVectorConfigurationCreatorForKurtosis(logsListeningPortNum, httpPortNumber, sinks, shouldTurnOffPersistentVolumeLogsCollection)
