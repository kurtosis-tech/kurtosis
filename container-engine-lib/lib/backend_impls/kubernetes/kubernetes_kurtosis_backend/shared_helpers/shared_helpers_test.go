...
func TestGetServicePortsFromPortSpecs(t *testing.T) {
	...
	portSpec1, err := port_spec.NewPortSpec(100, port_spec.TransportProtocol_TCP, "")
	require.NoError(t, err)
	portSpec2, err := port_spec.NewPortSpec(200, port_spec.TransportProtocol_UDP, "")
	require.NoError(t, err)
	portSpec3, err := port_spec.NewPortSpec(300, port_spec.TransportProtocol_SCTP, "")
	require.NoError(t, err)
