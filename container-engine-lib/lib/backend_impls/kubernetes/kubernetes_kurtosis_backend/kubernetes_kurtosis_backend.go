...
func (backend *KubernetesKurtosisBackend) DestroyLogsStorage(ctx context.Context) error {
	// TODO IMPLEMENT
	return stacktrace.NewError("Log storage isn't yet implemented on Kubernetes")
}
