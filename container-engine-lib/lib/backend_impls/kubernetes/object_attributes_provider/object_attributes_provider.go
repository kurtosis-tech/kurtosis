...
type KubernetesObjectAttributesProvider interface {
	...
	ForLogsDatabase(logsDatabaseGuid logs_database.LogsDatabaseGUID) KubernetesLogsDatabaseObjectAttributesProvider
}
...
func (provider *kubernetesObjectAttributesProviderImpl) ForLogsDatabase(logsDatabaseGuid logs_database.LogsDatabaseGUID) KubernetesLogsDatabaseObjectAttributesProvider {
	return GetKubernetesLogsDatabaseObjectAttributesProvider(logsDatabaseGuid)
}
