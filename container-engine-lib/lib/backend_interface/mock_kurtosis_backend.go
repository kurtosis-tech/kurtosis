...
// StartUserServices provides a mock function with given fields: ctx, enclaveId, services
func (_m *MockKurtosisBackend) StartUserServices(ctx context.Context, enclaveId enclave.EnclaveID, services map[service.ServiceID]*service.ServiceConfig) (map[service.ServiceID]*service.Service, map[service.ServiceID]error, error) {
	ret := _m.Called(ctx, enclaveId, services)

	var r0 map[service.ServiceID]*service.Service
	if rf, ok := ret.Get(0).(func(context.Context, enclave.EnclaveID, map[service.ServiceID]*service.ServiceConfig) map[service.ServiceID]*service.Service); ok {
		r0 = rf(ctx, enclaveId, services)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[service.ServiceID]*service.Service)
		}
	}

	var r1 map[service.ServiceID]error
	if rf, ok := ret.Get(1).(func(context.Context, enclave.EnclaveID, map[service.ServiceID]*service.ServiceConfig) map[service.ServiceID]error); ok {
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(context.Context, enclave.EnclaveID, map[service.ServiceID]*service.ServiceConfig) error); ok {
...
func (_e *MockKurtosisBackend_Expecter) StartUserServices(ctx interface{}, enclaveId interface{}, services interface{}) *MockKurtosisBackend_StartUserServices_Call {
	return &MockKurtosisBackend_StartUserServices_Call{Call: _e.mock.On("StartUserServices", ctx, enclaveId, services)}
}

func (_c *MockKurtosisBackend_StartUserServices_Call) Run(run func(ctx context.Context, enclaveId enclave.EnclaveID, services map[service.ServiceID]*service.ServiceConfig)) *MockKurtosisBackend_StartUserServices_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(enclave.EnclaveID), args[2].(map[service.ServiceID]*service.ServiceConfig))
	})
	return _c
}

func (_c *MockKurtosisBackend_StartUserServices_Call) Return(successfulServices map[service.ServiceID]*service.Service, unsuccessfulServices map[service.ServiceID]error, resultErr error) *MockKurtosisBackend_StartUserServices_Call {
	_c.Call.Return(successfulServices, unsuccessfulServices, resultErr)
	return _c
}
