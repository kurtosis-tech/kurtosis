...
// GetConnectionWithUserService provides a mock function with given fields: ctx, enclaveUuid, serviceUuid, commandToRunInsteadOfBash
func (_m *MockKurtosisBackend) GetConnectionWithUserService(ctx context.Context, enclaveUuid enclave.EnclaveUUID, serviceUuid service.ServiceUUID, commandToRunInsteadOfBash string) (net.Conn, error) {
	ret := _m.Called(ctx, enclaveUuid, serviceUuid, commandToRunInsteadOfBash)

	var r0 net.Conn
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, enclave.EnclaveUUID, service.ServiceUUID, string) (net.Conn, error)); ok {
		return rf(ctx, enclaveUuid, serviceUuid, commandToRunInsteadOfBash)
	}
	if rf, ok := ret.Get(0).(func(context.Context, enclave.EnclaveUUID, service.ServiceUUID, string) net.Conn); ok {
		r0 = rf(ctx, enclaveUuid, serviceUuid, commandToRunInsteadOfBash)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, enclave.EnclaveUUID, service.ServiceUUID, string) error); ok {
		r1 = rf(ctx, enclaveUuid, serviceUuid, commandToRunInsteadOfBash)
	} else {
		r1 = ret.Error(1)
	}
...
//   - enclaveUuid enclave.EnclaveUUID
//   - serviceUuid service.ServiceUUID
//   - commandToRunInsteadOfBash string
func (_e *MockKurtosisBackend_Expecter) GetConnectionWithUserService(ctx interface{}, enclaveUuid interface{}, serviceUuid interface{}, commandToRunInsteadOfBash interface{}) *MockKurtosisBackend_GetConnectionWithUserService_Call {
	return &MockKurtosisBackend_GetConnectionWithUserService_Call{Call: _e.mock.On("GetConnectionWithUserService", ctx, enclaveUuid, serviceUuid, commandToRunInsteadOfBash)}
}

func (_c *MockKurtosisBackend_GetConnectionWithUserService_Call) Run(run func(ctx context.Context, enclaveUuid enclave.EnclaveUUID, serviceUuid service.ServiceUUID, commandToRunInsteadOfBash string)) *MockKurtosisBackend_GetConnectionWithUserService_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockKurtosisBackend_GetConnectionWithUserService_Call) RunAndReturn(run func(context.Context, enclave.EnclaveUUID, service.ServiceUUID, string) (net.Conn, error)) *MockKurtosisBackend_GetConnectionWithUserService_Call {
	_c.Call.Return(run)
	return _c
}
...
// StartUserServices provides a mock function with given fields: ctx, enclaveUuid, filters
func (_m *MockKurtosisBackend) StartUserServices(ctx context.Context, enclaveUuid enclave.EnclaveUUID, filters *service.ServiceFilters) (map[service.ServiceUUID]bool, map[service.ServiceUUID]error, error) {
	ret := _m.Called(ctx, enclaveUuid, filters)
...
// MockKurtosisBackend_StartUserServices_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StartUserServices'
type MockKurtosisBackend_StartUserServices_Call struct {
	*mock.Call
}

// StartUserServices is a helper method to define mock.On call
//   - ctx context.Context
//   - enclaveUuid enclave.EnclaveUUID
//   - filters *service.ServiceFilters
func (_e *MockKurtosisBackend_Expecter) StartUserServices(ctx interface{}, enclaveUuid interface{}, filters interface{}) *MockKurtosisBackend_StartUserServices_Call {
	return &MockKurtosisBackend_StartUserServices_Call{Call: _e.mock.On("StartUserServices", ctx, enclaveUuid, filters)}
}

func (_c *MockKurtosisBackend_StartUserServices_Call) Run(run func(ctx context.Context, enclaveUuid enclave.EnclaveUUID, filters *service.ServiceFilters)) *MockKurtosisBackend_StartUserServices_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(enclave.EnclaveUUID), args[2].(*service.ServiceFilters))
	})
	return _c
...
func (_c *MockKurtosisBackend_StartUserServices_Call) Return(successfulUserServiceUuids map[service.ServiceUUID]bool, erroredUserServiceUuids map[service.ServiceUUID]error, resultErr error) *MockKurtosisBackend_StartUserServices_Call {
	_c.Call.Return(successfulUserServiceUuids, erroredUserServiceUuids, resultErr)
	return _c
}

func (_c *MockKurtosisBackend_StartUserServices_Call) RunAndReturn(run func(context.Context, enclave.EnclaveUUID, *service.ServiceFilters) (map[service.ServiceUUID]bool, map[service.ServiceUUID]error, error)) *MockKurtosisBackend_StartUserServices_Call {
	_c.Call.Return(run)
	return _c
}
