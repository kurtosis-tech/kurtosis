...
import (
	...
	image_registry_spec "github.com/kurtosis-tech/kurtosis/container-engine-lib/lib/backend_interface/objects/image_spec"
...
func (_m *MockKurtosisBackend) FetchImage(ctx context.Context, image string, registrySpec *image_registry_spec.ImageSpec, downloadMode image_download_mode.ImageDownloadMode) (bool, string, error) {
	ret := _m.Called(ctx, image, registrySpec, downloadMode)

	var r0 bool
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *image_registry_spec.ImageSpec, image_download_mode.ImageDownloadMode) (bool, string, error)); ok {
		return rf(ctx, image, registrySpec, downloadMode)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *image_registry_spec.ImageSpec, image_download_mode.ImageDownloadMode) bool); ok {
		r0 = rf(ctx, image, registrySpec, downloadMode)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, *image_registry_spec.ImageSpec, image_download_mode.ImageDownloadMode) string); ok {
		r1 = rf(ctx, image, registrySpec, downloadMode)
	} else {
		r1 = ret.Get(1).(string)
	}

	if rf, ok := ret.Get(2).(func(context.Context, string, *image_registry_spec.ImageSpec, image_download_mode.ImageDownloadMode) error); ok {
...
//   - ctx context.Context
//   - image string
//   - registrySpec *image_spec.ImageSpec
...
func (_c *MockKurtosisBackend_FetchImage_Call) Run(run func(ctx context.Context, image string, registrySpec *image_registry_spec.ImageSpec, downloadMode image_download_mode.ImageDownloadMode)) *MockKurtosisBackend_FetchImage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*image_registry_spec.ImageSpec), args[3].(image_download_mode.ImageDownloadMode))
	})
	return _c
}
...
func (_c *MockKurtosisBackend_FetchImage_Call) RunAndReturn(run func(context.Context, string, *image_registry_spec.ImageSpec, image_download_mode.ImageDownloadMode) (bool, string, error)) *MockKurtosisBackend_FetchImage_Call {
	_c.Call.Return(run)
	return _c
}
