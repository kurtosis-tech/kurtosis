...
// CreateAPIContainer provides a mock function with given fields: ctx, image, enclaveUuid, grpcPortNum, tunnelPortNum, enclaveDataVolumeDirpath, ownIpAddressEnvVar, customEnvVars
func (_m *MockKurtosisBackend) CreateAPIContainer(ctx context.Context, image string, enclaveUuid enclave.EnclaveUUID, grpcPortNum uint16, tunnelPortNum uint16, enclaveDataVolumeDirpath string, ownIpAddressEnvVar string, customEnvVars map[string]string) (*api_container.APIContainer, error) {
	ret := _m.Called(ctx, image, enclaveUuid, grpcPortNum, tunnelPortNum, enclaveDataVolumeDirpath, ownIpAddressEnvVar, customEnvVars)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, enclave.EnclaveUUID, uint16, uint16, string, string, map[string]string) (*api_container.APIContainer, error)); ok {
		return rf(ctx, image, enclaveUuid, grpcPortNum, tunnelPortNum, enclaveDataVolumeDirpath, ownIpAddressEnvVar, customEnvVars)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, enclave.EnclaveUUID, uint16, uint16, string, string, map[string]string) *api_container.APIContainer); ok {
		r0 = rf(ctx, image, enclaveUuid, grpcPortNum, tunnelPortNum, enclaveDataVolumeDirpath, ownIpAddressEnvVar, customEnvVars)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, enclave.EnclaveUUID, uint16, uint16, string, string, map[string]string) error); ok {
		r1 = rf(ctx, image, enclaveUuid, grpcPortNum, tunnelPortNum, enclaveDataVolumeDirpath, ownIpAddressEnvVar, customEnvVars)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockKurtosisBackend_Expecter) CreateAPIContainer(ctx interface{}, image interface{}, enclaveUuid interface{}, grpcPortNum interface{}, tunnelPortNum interface{}, enclaveDataVolumeDirpath interface{}, ownIpAddressEnvVar interface{}, customEnvVars interface{}) *MockKurtosisBackend_CreateAPIContainer_Call {
	return &MockKurtosisBackend_CreateAPIContainer_Call{Call: _e.mock.On("CreateAPIContainer", ctx, image, enclaveUuid, grpcPortNum, tunnelPortNum, enclaveDataVolumeDirpath, ownIpAddressEnvVar, customEnvVars)}
}

func (_c *MockKurtosisBackend_CreateAPIContainer_Call) Run(run func(ctx context.Context, image string, enclaveUuid enclave.EnclaveUUID, grpcPortNum uint16, tunnelPortNum uint16, enclaveDataVolumeDirpath string, ownIpAddressEnvVar string, customEnvVars map[string]string)) *MockKurtosisBackend_CreateAPIContainer_Call {
	_c.Call.Run(func(args mock.Arguments) {
