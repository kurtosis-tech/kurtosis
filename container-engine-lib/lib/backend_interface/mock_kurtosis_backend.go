...
// StartAPIContainers provides a mock function with given fields: ctx, filters
func (_m *MockKurtosisBackend) StartAPIContainers(ctx context.Context, filters *api_container.APIContainerFilters) (map[enclave.EnclaveUUID]bool, map[enclave.EnclaveUUID]error, error) {
	ret := _m.Called(ctx, filters)
...
// MockKurtosisBackend_StartAPIContainers_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StartAPIContainers'
type MockKurtosisBackend_StartAPIContainers_Call struct {
	*mock.Call
}

// StartAPIContainers is a helper method to define mock.On call
//   - ctx context.Context
//   - filters *api_container.APIContainerFilters
func (_e *MockKurtosisBackend_Expecter) StartAPIContainers(ctx interface{}, filters interface{}) *MockKurtosisBackend_StartAPIContainers_Call {
	return &MockKurtosisBackend_StartAPIContainers_Call{Call: _e.mock.On("StartAPIContainers", ctx, filters)}
}

func (_c *MockKurtosisBackend_StartAPIContainers_Call) Run(run func(ctx context.Context, filters *api_container.APIContainerFilters)) *MockKurtosisBackend_StartAPIContainers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*api_container.APIContainerFilters))
	})
	return _c
...
func (_c *MockKurtosisBackend_StartAPIContainers_Call) Return(successfulApiContainerIds map[enclave.EnclaveUUID]bool, erroredApiContainerIds map[enclave.EnclaveUUID]error, resultErr error) *MockKurtosisBackend_StartAPIContainers_Call {
	_c.Call.Return(successfulApiContainerIds, erroredApiContainerIds, resultErr)
	return _c
}

func (_c *MockKurtosisBackend_StartAPIContainers_Call) RunAndReturn(run func(context.Context, *api_container.APIContainerFilters) (map[enclave.EnclaveUUID]bool, map[enclave.EnclaveUUID]error, error)) *MockKurtosisBackend_StartAPIContainers_Call {
	_c.Call.Return(run)
	return _c
}

// StartLogsCollectorForEnclave provides a mock function with given fields: ctx, enclaveUuid
func (_m *MockKurtosisBackend) StartLogsCollectorForEnclave(ctx context.Context, enclaveUuid enclave.EnclaveUUID) error {
	ret := _m.Called(ctx, enclaveUuid)
...
// MockKurtosisBackend_StartLogsCollectorForEnclave_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StartLogsCollectorForEnclave'
type MockKurtosisBackend_StartLogsCollectorForEnclave_Call struct {
	*mock.Call
}

// StartLogsCollectorForEnclave is a helper method to define mock.On call
//   - ctx context.Context
//   - enclaveUuid enclave.EnclaveUUID
func (_e *MockKurtosisBackend_Expecter) StartLogsCollectorForEnclave(ctx interface{}, enclaveUuid interface{}) *MockKurtosisBackend_StartLogsCollectorForEnclave_Call {
	return &MockKurtosisBackend_StartLogsCollectorForEnclave_Call{Call: _e.mock.On("StartLogsCollectorForEnclave", ctx, enclaveUuid)}
}

func (_c *MockKurtosisBackend_StartLogsCollectorForEnclave_Call) Run(run func(ctx context.Context, enclaveUuid enclave.EnclaveUUID)) *MockKurtosisBackend_StartLogsCollectorForEnclave_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(enclave.EnclaveUUID))
	})
	return _c
...
func (_c *MockKurtosisBackend_StartLogsCollectorForEnclave_Call) Return(_a0 error) *MockKurtosisBackend_StartLogsCollectorForEnclave_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockKurtosisBackend_StartLogsCollectorForEnclave_Call) RunAndReturn(run func(context.Context, enclave.EnclaveUUID) error) *MockKurtosisBackend_StartLogsCollectorForEnclave_Call {
	_c.Call.Return(run)
	return _c
}
