...
// DestroyLogsStorage provides a mock function with given fields: ctx
func (_m *MockKurtosisBackend) DestroyLogsStorage(ctx context.Context) error {
	ret := _m.Called(ctx)
...
// MockKurtosisBackend_DestroyLogsStorage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DestroyLogsStorage'
type MockKurtosisBackend_DestroyLogsStorage_Call struct {
	*mock.Call
}

// DestroyLogsStorage is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockKurtosisBackend_Expecter) DestroyLogsStorage(ctx interface{}) *MockKurtosisBackend_DestroyLogsStorage_Call {
	return &MockKurtosisBackend_DestroyLogsStorage_Call{Call: _e.mock.On("DestroyLogsStorage", ctx)}
}

func (_c *MockKurtosisBackend_DestroyLogsStorage_Call) Run(run func(ctx context.Context)) *MockKurtosisBackend_DestroyLogsStorage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockKurtosisBackend_DestroyLogsStorage_Call) Return(_a0 error) *MockKurtosisBackend_DestroyLogsStorage_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockKurtosisBackend_DestroyLogsStorage_Call) RunAndReturn(run func(context.Context) error) *MockKurtosisBackend_DestroyLogsStorage_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockKurtosisBackend_FetchImage_Call) Return(_a0 bool, _a1 error) *MockKurtosisBackend_FetchImage_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
