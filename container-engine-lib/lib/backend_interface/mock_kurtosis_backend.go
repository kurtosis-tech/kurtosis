...
func (_m *MockKurtosisBackend) GetAvailableCPUAndMemory(ctx context.Context) (uint64, bool, float64, bool, error) {
	...
	var r3 bool
	var r4 error
	if rf, ok := ret.Get(0).(func(context.Context) (uint64, bool, float64, bool, error)); ok {
		return rf(ctx)
	}
	...
	if rf, ok := ret.Get(2).(func(context.Context) float64); ok {
		r2 = rf(ctx)
	} else {
...
func (_c *MockKurtosisBackend_GetAvailableCPUAndMemory_Call) Return(_a0 uint64, _a1 bool, _a2 float64, _a3 bool, _a4 error) *MockKurtosisBackend_GetAvailableCPUAndMemory_Call {
	_c.Call.Return(_a0, _a1, _a2, _a3, _a4)
	return _c
}

func (_c *MockKurtosisBackend_GetAvailableCPUAndMemory_Call) RunAndReturn(run func(context.Context) (uint64, bool, float64, bool, error)) *MockKurtosisBackend_GetAvailableCPUAndMemory_Call {
	_c.Call.Return(run)
	return _c
}
