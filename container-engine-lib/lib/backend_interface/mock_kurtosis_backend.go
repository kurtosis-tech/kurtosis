...
// CreateEngine provides a mock function with given fields: ctx, imageOrgAndRepo, imageVersionTag, grpcPortNum, envVars, shouldStartInDebugMode, githubAuthToken, sinks
func (_m *MockKurtosisBackend) CreateEngine(ctx context.Context, imageOrgAndRepo string, imageVersionTag string, grpcPortNum uint16, envVars map[string]string, shouldStartInDebugMode bool, githubAuthToken string, sinks logs_aggregator.Sinks) (*engine.Engine, error) {
	ret := _m.Called(ctx, imageOrgAndRepo, imageVersionTag, grpcPortNum, envVars, shouldStartInDebugMode, githubAuthToken, sinks)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, uint16, map[string]string, bool, string, logs_aggregator.Sinks) (*engine.Engine, error)); ok {
		return rf(ctx, imageOrgAndRepo, imageVersionTag, grpcPortNum, envVars, shouldStartInDebugMode, githubAuthToken, sinks)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, uint16, map[string]string, bool, string, logs_aggregator.Sinks) *engine.Engine); ok {
		r0 = rf(ctx, imageOrgAndRepo, imageVersionTag, grpcPortNum, envVars, shouldStartInDebugMode, githubAuthToken, sinks)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, uint16, map[string]string, bool, string, logs_aggregator.Sinks) error); ok {
		r1 = rf(ctx, imageOrgAndRepo, imageVersionTag, grpcPortNum, envVars, shouldStartInDebugMode, githubAuthToken, sinks)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockKurtosisBackend_Expecter) CreateEngine(ctx interface{}, imageOrgAndRepo interface{}, imageVersionTag interface{}, grpcPortNum interface{}, envVars interface{}, shouldStartInDebugMode interface{}, githubAuthToken interface{}, sinks interface{}) *MockKurtosisBackend_CreateEngine_Call {
	return &MockKurtosisBackend_CreateEngine_Call{Call: _e.mock.On("CreateEngine", ctx, imageOrgAndRepo, imageVersionTag, grpcPortNum, envVars, shouldStartInDebugMode, githubAuthToken, sinks)}
}

func (_c *MockKurtosisBackend_CreateEngine_Call) Run(run func(ctx context.Context, imageOrgAndRepo string, imageVersionTag string, grpcPortNum uint16, envVars map[string]string, shouldStartInDebugMode bool, githubAuthToken string, sinks logs_aggregator.Sinks)) *MockKurtosisBackend_CreateEngine_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(uint16), args[4].(map[string]string), args[5].(bool), args[6].(string), args[7].(logs_aggregator.Sinks))
	})
	return _c
}
...
func (_c *MockKurtosisBackend_CreateEngine_Call) RunAndReturn(run func(context.Context, string, string, uint16, map[string]string, bool, string, logs_aggregator.Sinks) (*engine.Engine, error)) *MockKurtosisBackend_CreateEngine_Call {
	_c.Call.Return(run)
	return _c
}
...
// NixBuild provides a mock function with given fields: ctx, nixBuildSpec
func (_m *MockKurtosisBackend) NixBuild(ctx context.Context, nixBuildSpec *nix_build_spec.NixBuildSpec) (string, error) {
	ret := _m.Called(ctx, nixBuildSpec)

	if len(ret) == 0 {
		panic("no return value specified for NixBuild")
	}

	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *nix_build_spec.NixBuildSpec) (string, error)); ok {
		return rf(ctx, nixBuildSpec)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *nix_build_spec.NixBuildSpec) string); ok {
		r0 = rf(ctx, nixBuildSpec)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *nix_build_spec.NixBuildSpec) error); ok {
		r1 = rf(ctx, nixBuildSpec)
	} else {
		r1 = ret.Error(1)
	}
...
// MockKurtosisBackend_NixBuild_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NixBuild'
type MockKurtosisBackend_NixBuild_Call struct {
	*mock.Call
}

// NixBuild is a helper method to define mock.On call
//   - ctx context.Context
//   - nixBuildSpec *nix_build_spec.NixBuildSpec
func (_e *MockKurtosisBackend_Expecter) NixBuild(ctx interface{}, nixBuildSpec interface{}) *MockKurtosisBackend_NixBuild_Call {
	return &MockKurtosisBackend_NixBuild_Call{Call: _e.mock.On("NixBuild", ctx, nixBuildSpec)}
}

func (_c *MockKurtosisBackend_NixBuild_Call) Run(run func(ctx context.Context, nixBuildSpec *nix_build_spec.NixBuildSpec)) *MockKurtosisBackend_NixBuild_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*nix_build_spec.NixBuildSpec))
	})
	return _c
}

func (_c *MockKurtosisBackend_NixBuild_Call) Return(_a0 string, _a1 error) *MockKurtosisBackend_NixBuild_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockKurtosisBackend_NixBuild_Call) RunAndReturn(run func(context.Context, *nix_build_spec.NixBuildSpec) (string, error)) *MockKurtosisBackend_NixBuild_Call {
	_c.Call.Return(run)
	return _c
}
...
// RunUserServiceExecCommands provides a mock function with given fields: ctx, enclaveUuid, containerUser, userServiceCommands
func (_m *MockKurtosisBackend) RunUserServiceExecCommands(ctx context.Context, enclaveUuid enclave.EnclaveUUID, containerUser string, userServiceCommands map[service.ServiceUUID][]string) (map[service.ServiceUUID]*exec_result.ExecResult, map[service.ServiceUUID]error, error) {
	ret := _m.Called(ctx, enclaveUuid, containerUser, userServiceCommands)
	...
	var r1 map[service.ServiceUUID]error
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, enclave.EnclaveUUID, string, map[service.ServiceUUID][]string) (map[service.ServiceUUID]*exec_result.ExecResult, map[service.ServiceUUID]error, error)); ok {
		return rf(ctx, enclaveUuid, containerUser, userServiceCommands)
	}
	if rf, ok := ret.Get(0).(func(context.Context, enclave.EnclaveUUID, string, map[service.ServiceUUID][]string) map[service.ServiceUUID]*exec_result.ExecResult); ok {
		r0 = rf(ctx, enclaveUuid, containerUser, userServiceCommands)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, enclave.EnclaveUUID, string, map[service.ServiceUUID][]string) map[service.ServiceUUID]error); ok {
		r1 = rf(ctx, enclaveUuid, containerUser, userServiceCommands)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(map[service.ServiceUUID]error)
		}
	...
	if rf, ok := ret.Get(2).(func(context.Context, enclave.EnclaveUUID, string, map[service.ServiceUUID][]string) error); ok {
		r2 = rf(ctx, enclaveUuid, containerUser, userServiceCommands)
	} else {
		r2 = ret.Error(2)
	}
...
func (_e *MockKurtosisBackend_Expecter) RunUserServiceExecCommands(ctx interface{}, enclaveUuid interface{}, containerUser interface{}, userServiceCommands interface{}) *MockKurtosisBackend_RunUserServiceExecCommands_Call {
	return &MockKurtosisBackend_RunUserServiceExecCommands_Call{Call: _e.mock.On("RunUserServiceExecCommands", ctx, enclaveUuid, containerUser, userServiceCommands)}
}

func (_c *MockKurtosisBackend_RunUserServiceExecCommands_Call) Run(run func(ctx context.Context, enclaveUuid enclave.EnclaveUUID, containerUser string, userServiceCommands map[service.ServiceUUID][]string)) *MockKurtosisBackend_RunUserServiceExecCommands_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(enclave.EnclaveUUID), args[2].(string), args[3].(map[service.ServiceUUID][]string))
	})
	return _c
}

func (_c *MockKurtosisBackend_RunUserServiceExecCommands_Call) Return(successfulUserServiceExecResults map[service.ServiceUUID]*exec_result.ExecResult, erroredUserServiceUuids map[service.ServiceUUID]error, resultErr error) *MockKurtosisBackend_RunUserServiceExecCommands_Call {
	_c.Call.Return(successfulUserServiceExecResults, erroredUserServiceUuids, resultErr)
	return _c
}

func (_c *MockKurtosisBackend_RunUserServiceExecCommands_Call) RunAndReturn(run func(context.Context, enclave.EnclaveUUID, string, map[service.ServiceUUID][]string) (map[service.ServiceUUID]*exec_result.ExecResult, map[service.ServiceUUID]error, error)) *MockKurtosisBackend_RunUserServiceExecCommands_Call {
	_c.Call.Return(run)
	return _c
}
