...
// RunUserServiceExecCommandsAsUser provides a mock function with given fields: ctx, enclaveUuid, containerUser, userServiceCommands
func (_m *MockKurtosisBackend) RunUserServiceExecCommandsAsUser(ctx context.Context, enclaveUuid enclave.EnclaveUUID, containerUser string, userServiceCommands map[service.ServiceUUID][]string) (map[service.ServiceUUID]*exec_result.ExecResult, map[service.ServiceUUID]error, error) {
	ret := _m.Called(ctx, enclaveUuid, containerUser, userServiceCommands)

	if len(ret) == 0 {
		panic("no return value specified for RunUserServiceExecCommandsAsUser")
	}
...
// MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RunUserServiceExecCommandsAsUser'
type MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call struct {
	*mock.Call
}

// RunUserServiceExecCommandsAsUser is a helper method to define mock.On call
//   - ctx context.Context
//   - enclaveUuid enclave.EnclaveUUID
//   - containerUser string
//   - userServiceCommands map[service.ServiceUUID][]string
func (_e *MockKurtosisBackend_Expecter) RunUserServiceExecCommandsAsUser(ctx interface{}, enclaveUuid interface{}, containerUser interface{}, userServiceCommands interface{}) *MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call {
	return &MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call{Call: _e.mock.On("RunUserServiceExecCommandsAsUser", ctx, enclaveUuid, containerUser, userServiceCommands)}
}

func (_c *MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call) Run(run func(ctx context.Context, enclaveUuid enclave.EnclaveUUID, containerUser string, userServiceCommands map[service.ServiceUUID][]string)) *MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call) Return(successfulUserServiceExecResults map[service.ServiceUUID]*exec_result.ExecResult, erroredUserServiceUuids map[service.ServiceUUID]error, resultErr error) *MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call {
	_c.Call.Return(successfulUserServiceExecResults, erroredUserServiceUuids, resultErr)
	return _c
}

func (_c *MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call) RunAndReturn(run func(context.Context, enclave.EnclaveUUID, string, map[service.ServiceUUID][]string) (map[service.ServiceUUID]*exec_result.ExecResult, map[service.ServiceUUID]error, error)) *MockKurtosisBackend_RunUserServiceExecCommandsAsUser_Call {
	_c.Call.Return(run)
	return _c
}
