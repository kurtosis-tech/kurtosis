// Code generated by "enumer -trimprefix=EngineStatus_ -transform=snake-upper -type=EngineStatus"; DO NOT EDIT.
...
const _EngineStatusName = "STOPPEDRUNNING"

var _EngineStatusIndex = [...]uint8{0, 7, 14}

const _EngineStatusLowerName = "stoppedrunning"
...
var _EngineStatusNameToValueMap = map[string]EngineStatus{
	_EngineStatusName[0:7]:       EngineStatus_Stopped,
	_EngineStatusLowerName[0:7]:  EngineStatus_Stopped,
	_EngineStatusName[7:14]:      EngineStatus_Running,
	_EngineStatusLowerName[7:14]: EngineStatus_Running,
}

var _EngineStatusNames = []string{
	_EngineStatusName[0:7],
	_EngineStatusName[7:14],
}
