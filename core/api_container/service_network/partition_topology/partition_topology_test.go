...
const (
	...
	partition1 service_network_types2.PartitionID = "partition1"
	partition2 service_network_types2.PartitionID = "partition2"
	partition3 service_network_types2.PartitionID = "partition3"

	service1 service_network_types2.ServiceID = "service1"
	service2 service_network_types2.ServiceID = "service2"
	service3 service_network_types2.ServiceID = "service3"

	// How many nodes in a "huge" network, for benchmarking
	hugeNetworkNodeCount = 10000
)

var allTestServiceIds = map[service_network_types2.ServiceID]bool{
	service1: true,
	service2: true,
	service3: true,
}
...
func BenchmarkHugeNetworkPathologicalRepartition(b *testing.B) {
	...
	newPartitionConnections := map[service_network_types2.PartitionConnectionID]PartitionConnection{}
	for i := 0; i < hugeNetworkNodeCount; i++ {
		partitionId := service_network_types2.PartitionID(partitionIdPrefix + strconv.Itoa(i))
		serviceId := service_network_types2.ServiceID(serviceIdPrefix + strconv.Itoa(i))
		newPartitionServices[partitionId] = service_network_types2.NewServiceIDSet(serviceId)

		if i > 0 {
			previousPartitionId := service_network_types2.PartitionID(partitionIdPrefix + strconv.Itoa(i - 1))
			partConnId := *service_network_types2.NewPartitionConnectionID(partitionId, previousPartitionId)
			newPartitionConnections[partConnId] = PartitionConnection{IsBlocked: false}
		}
		if i < (hugeNetworkNodeCount - 1) {
			nextPartitionId := service_network_types2.PartitionID(partitionIdPrefix + strconv.Itoa(i + 1))
			partConnId := *service_network_types2.NewPartitionConnectionID(partitionId, nextPartitionId)
			newPartitionConnections[partConnId] = PartitionConnection{IsBlocked: false}
		}
	}
...
func TestAllServicesAreAlwaysInBlocklist(t *testing.T) {
	...
	repartition(
		t,
		topology,
		service_network_types2.NewServiceIDSet(service1),
		service_network_types2.NewServiceIDSet(service2),
		service_network_types2.NewServiceIDSet(service3),
		map[service_network_types2.PartitionConnectionID]PartitionConnection{},
		true)
...
func TestServicesInSamePartitionAreNeverBlocked(t *testing.T) {
	...
	repartition(
		t,
		topology,
		service_network_types2.NewServiceIDSet(service1, service2),
		service_network_types2.NewServiceIDSet(),
		service_network_types2.NewServiceIDSet(service3),
		map[service_network_types2.PartitionConnectionID]PartitionConnection{},
		true)
...
func TestExplicitConnectionBlocksWork(t *testing.T) {
	...
	repartition(
		...
		map[service_network_types2.PartitionConnectionID]PartitionConnection{
			...
			*service_network_types2.NewPartitionConnectionID(partition1, partition2): {
				IsBlocked: false,
			},
			*service_network_types2.NewPartitionConnectionID(partition2, partition3): {
				IsBlocked: false,
			},
			// Access between 1 and 3 is blocked
			*service_network_types2.NewPartitionConnectionID(partition1, partition3): {
				IsBlocked: true,
			},
		},
		true)
...
func TestDuplicateServicesError(t *testing.T) {
	...
	err := topology.Repartition(
		map[service_network_types2.PartitionID]*service_network_types2.ServiceIDSet{
			partition1: service_network_types2.NewServiceIDSet(service1),
			partition2: service_network_types2.NewServiceIDSet(service1, service2), // Should cause error
			partition3: service_network_types2.NewServiceIDSet(service3),
		},
		map[service_network_types2.PartitionConnectionID]PartitionConnection{},
...
func TestUnknownServicesError(t *testing.T) {
	...
	err := topology.Repartition(
		map[service_network_types2.PartitionID]*service_network_types2.ServiceIDSet{
			partition1: service_network_types2.NewServiceIDSet(service1, "unknown-service"), // Should error
			partition2: service_network_types2.NewServiceIDSet(service2),
			partition3: service_network_types2.NewServiceIDSet(service3),
		},
		map[service_network_types2.PartitionConnectionID]PartitionConnection{},
		PartitionConnection{IsBlocked: false})
...
func TestNotAllServicesAllocatedError(t *testing.T) {
	...
	err := topology.Repartition(
		map[service_network_types2.PartitionID]*service_network_types2.ServiceIDSet{
			partition1: service_network_types2.NewServiceIDSet(),
			partition2: service_network_types2.NewServiceIDSet(service2),
			partition3: service_network_types2.NewServiceIDSet(service3),
		},
		map[service_network_types2.PartitionConnectionID]PartitionConnection{},
...
func TestUnknownPartitionsError(t *testing.T) {
	...
	firstPartErr := topology.Repartition(
		map[service_network_types2.PartitionID]*service_network_types2.ServiceIDSet{
			partition1: service_network_types2.NewServiceIDSet(service1),
			partition2: service_network_types2.NewServiceIDSet(service2, service3),
		},
		map[service_network_types2.PartitionConnectionID]PartitionConnection{
			*service_network_types2.NewPartitionConnectionID("aa-unknown-partition", partition2): {
				IsBlocked: true,
			},
		},
		PartitionConnection{IsBlocked: false})
	...
	secondPartErr := topology.Repartition(
		...
		map[service_network_types2.PartitionConnectionID]PartitionConnection{
			*service_network_types2.NewPartitionConnectionID("zz-unknown-partition", partition2): {
				IsBlocked: true,
			},
		},
		PartitionConnection{IsBlocked: false})
...
func getHugeTestTopology(t *testing.B, serviceIdPrefx string, isDefaultConnBlocked bool) *PartitionTopology {
	...
	for i := 0; i < hugeNetworkNodeCount; i++ {
		serviceId := service_network_types2.ServiceID(serviceIdPrefx + strconv.Itoa(i))
...
func repartition(
		...
		partition1Services *service_network_types2.ServiceIDSet,
		partition2Services *service_network_types2.ServiceIDSet,
		partition3Services *service_network_types2.ServiceIDSet,
		connections map[service_network_types2.PartitionConnectionID]PartitionConnection,
...
func getBlocklistsMap(t *testing.T, topology *PartitionTopology) map[service_network_types2.ServiceID]*service_network_types2.ServiceIDSet {
...
func getBlocklistForService(
		...
		blocklists map[service_network_types2.ServiceID]*service_network_types2.ServiceIDSet) *service_network_types2.ServiceIDSet {
...
func assertBlocklistsEqual(
		t *testing.T,
		expected map[service_network_types2.ServiceID]*service_network_types2.ServiceIDSet,
		actual map[service_network_types2.ServiceID]*service_network_types2.ServiceIDSet) {
	assert.Equal(
		t,
		len(expected),
		len(actual),
