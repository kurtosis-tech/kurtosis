...
func NewEnclaveContext(enclaveId string, networkId string, networkIpAndMask *net.IPNet, apiContainerId string, apiContainerIpAddr net.IP, replContainerIpAddr net.IP, testsuiteContainerIpAddr net.IP, testsuiteContainerName string, testsuiteContainerLabels map[string]string, dockerManager *docker_manager.DockerManager) *EnclaveContext {
	return &EnclaveContext{enclaveId: enclaveId, networkId: networkId, networkIpAndMask: networkIpAndMask, apiContainerId: apiContainerId, apiContainerIpAddr: apiContainerIpAddr, replContainerIpAddr: replContainerIpAddr, testsuiteContainerIpAddr: testsuiteContainerIpAddr, testsuiteContainerName: testsuiteContainerName, testsuiteContainerLabels: testsuiteContainerLabels, dockerManager: dockerManager}
}
