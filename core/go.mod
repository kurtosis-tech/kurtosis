...
require (
	...
	github.com/kurtosis-tech/kurtosis-client/golang v0.0.0-20210707225825-b5c3891b2d8c
	github.com/kurtosis-tech/kurtosis-libs/golang v0.0.0-20210706222051-6798d43ee14c
