...
require (
	...
	github.com/kurtosis-tech/kurtosis-client/golang v0.0.0-20210716225554-1b2d348613c5
	github.com/kurtosis-tech/kurtosis-lambda-api-lib/golang v0.0.0-20210716234030-dc27d5e676e9 // indirect
