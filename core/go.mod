...
require (
	...
	github.com/kurtosis-tech/kurtosis-client/golang v0.0.0-20210924194127-cd7e6fb28798 // indirect
	github.com/kurtosis-tech/kurtosis-core-launcher-lib v0.0.0-20210927194459-d128ccf5522b // indirect
