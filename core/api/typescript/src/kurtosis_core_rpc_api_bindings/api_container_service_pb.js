...
goog.exportSymbol('proto.api_container_api.RegisterServicesArgs', null, global);
goog.exportSymbol('proto.api_container_api.RegisterServicesResponse', null, global);
...
goog.exportSymbol('proto.api_container_api.RenderTemplateToFilesArtifactArgs', null, global);
goog.exportSymbol('proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString', null, global);
goog.exportSymbol('proto.api_container_api.RenderTemplateToFilesArtifactResponse', null, global);
 ...
 * @constructor
 */
proto.api_container_api.RegisterServicesArgs = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.RegisterServicesArgs, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.RegisterServicesArgs.displayName = 'proto.api_container_api.RegisterServicesArgs';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api_container_api.RegisterServicesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.RegisterServicesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.RegisterServicesResponse.displayName = 'proto.api_container_api.RegisterServicesResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.RenderTemplateToFilesArtifactArgs, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.RenderTemplateToFilesArtifactArgs.displayName = 'proto.api_container_api.RenderTemplateToFilesArtifactArgs';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.displayName = 'proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api_container_api.RenderTemplateToFilesArtifactResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.RenderTemplateToFilesArtifactResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.RenderTemplateToFilesArtifactResponse.displayName = 'proto.api_container_api.RenderTemplateToFilesArtifactResponse';
}
 ...
 * @return {!Object}
 */
proto.api_container_api.RegisterServicesArgs.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.RegisterServicesArgs.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.RegisterServicesArgs} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.RegisterServicesArgs.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api_container_api.RegisterServicesArgs}
 */
proto.api_container_api.RegisterServicesArgs.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.RegisterServicesArgs;
  return proto.api_container_api.RegisterServicesArgs.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.RegisterServicesArgs} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.RegisterServicesArgs}
 */
proto.api_container_api.RegisterServicesArgs.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.RegisterServicesArgs.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.RegisterServicesArgs.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.RegisterServicesArgs} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.RegisterServicesArgs.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!jspb.Map<string,boolean>}
 */
proto.api_container_api.RegisterServicesArgs.prototype.getServiceIdSetMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,boolean>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      null));
};
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.api_container_api.RegisterServicesArgs} returns this
 */
proto.api_container_api.RegisterServicesArgs.prototype.clearServiceIdSetMap = function() {
 ...
 * @return {string}
 */
proto.api_container_api.RegisterServicesArgs.prototype.getPartitionId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api_container_api.RegisterServicesArgs} returns this
 */
proto.api_container_api.RegisterServicesArgs.prototype.setPartitionId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.api_container_api.RegisterServicesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.RegisterServicesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.RegisterServicesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api_container_api.RegisterServicesResponse}
 */
proto.api_container_api.RegisterServicesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.RegisterServicesResponse;
  return proto.api_container_api.RegisterServicesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.RegisterServicesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.RegisterServicesResponse}
 */
proto.api_container_api.RegisterServicesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.RegisterServicesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.RegisterServicesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.RegisterServicesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @return {!Object}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.RenderTemplateToFilesArtifactArgs.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.RenderTemplateToFilesArtifactArgs} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.toObject = function(includeInstance, msg) {
  var f, obj = {
    templateAndDataByFilenameMap: (f = msg.getTemplateAndDataByFilenameMap()) ? f.toObject(includeInstance, proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.toObject) : []
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactArgs}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.RenderTemplateToFilesArtifactArgs;
  return proto.api_container_api.RenderTemplateToFilesArtifactArgs.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.RenderTemplateToFilesArtifactArgs} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactArgs}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = msg.getTemplateAndDataByFilenameMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.deserializeBinaryFromReader, "", new proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString());
         });
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.RenderTemplateToFilesArtifactArgs.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.RenderTemplateToFilesArtifactArgs} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTemplateAndDataByFilenameMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.serializeBinaryToWriter);
  }
};
 ...
 * @return {!Object}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString;
  return proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.prototype.getTemplate = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString} returns this
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.prototype.setTemplate = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.prototype.getDataAsJson = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString} returns this
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString.prototype.setDataAsJson = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * map<string, TemplateAndDataAsJsonString> template_and_data_by_filename = 1;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString>}
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.prototype.getTemplateAndDataByFilenameMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      proto.api_container_api.RenderTemplateToFilesArtifactArgs.TemplateAndDataAsJsonString));
};


/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactArgs} returns this
 */
proto.api_container_api.RenderTemplateToFilesArtifactArgs.prototype.clearTemplateAndDataByFilenameMap = function() {
  this.getTemplateAndDataByFilenameMap().clear();
  return this;};
 ...
 * @return {!Object}
 */
proto.api_container_api.RenderTemplateToFilesArtifactResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.RenderTemplateToFilesArtifactResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.RenderTemplateToFilesArtifactResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.RenderTemplateToFilesArtifactResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    uuid: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactResponse}
 */
proto.api_container_api.RenderTemplateToFilesArtifactResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.RenderTemplateToFilesArtifactResponse;
  return proto.api_container_api.RenderTemplateToFilesArtifactResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.RenderTemplateToFilesArtifactResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactResponse}
 */
proto.api_container_api.RenderTemplateToFilesArtifactResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.RenderTemplateToFilesArtifactResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.RenderTemplateToFilesArtifactResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.RenderTemplateToFilesArtifactResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.RenderTemplateToFilesArtifactResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUuid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api_container_api.RenderTemplateToFilesArtifactResponse.prototype.getUuid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api_container_api.RenderTemplateToFilesArtifactResponse} returns this
 */
proto.api_container_api.RenderTemplateToFilesArtifactResponse.prototype.setUuid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
