# TBD
### Features
* Add a global unique identifier for services `ServiceGUID` to avoid docker containers collisions and to match docker container name with services folders 
* Add a global unique identifier for lambdas `LambdaGUID` to avoid docker containers collisions and to match docker container name with lambdas folders 
