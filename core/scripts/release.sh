...
#                                             Main Logic
# ==================================================================================================
if ! bash "${RELEASE_SCRIPT_FILENAME}" "${root_dirpath}" "${script_dirpath}/${UPDATE_BUILD_AND_RUN_VERSION_FILENAME}" "${script_dirpath}/${UPDATE_OWN_VERSION_CONST_SCRIPT_FILENAME}"; then
