...
# Golang
go_output_dirpath="${api_dirpath}/${GOLANG_DIRNAME}/kurtosis_core_rpc_api_bindings"
...
# TypeScript
typescript_output_dirpath="${api_dirpath}/${TYPESCRIPT_DIRNAME}/src/kurtosis_core_rpc_api_bindings"
