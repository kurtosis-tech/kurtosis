...
"${root_dirpath}/build/kurtosis-core" "--license=${TRIAL_LICENSE}" "--test-suite-image=${GO_EXAMPLE_SUITE}" '--custom-env-vars-json={"GO_EXAMPLE_SERVICE_IMAGE":"nginxdemos/hello"}' ${*:-}
