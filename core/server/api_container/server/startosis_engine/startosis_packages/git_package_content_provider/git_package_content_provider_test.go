...
func Test_checkIfFileIsInAValidPackageInternal_somewhereInTheMiddle(t *testing.T) {
	...
	actual, err := getOptionalKurtosisYmlPathForFileUrlInternal(filePath, "/data/packages", mockStatMethod)
	require.Nil(t, err)
...
func Test_checkIfFileIsInAValidPackageInternal_unknownErrorOccurred(t *testing.T) {
	...
	filePath := "/data/packages/root/subdir/some_file.txt"
	_, err := getOptionalKurtosisYmlPathForFileUrlInternal(filePath, "/data/packages", mockStatMethod)
	require.NotNil(t, err)
...
func Test_validateKurtosisPackage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := validatePackageNameMatchesKurtosisYmlLocation(tt.args.kurtosisYaml, tt.args.absPathToPackageWithKurtosisYml, tt.args.packagesDir)
			if tt.want == nil {
				require.Nil(t, err)
			} else {
