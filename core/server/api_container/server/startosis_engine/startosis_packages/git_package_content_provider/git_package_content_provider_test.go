...
func TestGitPackageProvider_SucceedsForValidPackage(t *testing.T) {
	...
	provider := NewGitPackageContentProvider(packageDir, packageTmpDir, nil, nil)
...
func TestGitPackageProvider_FailsForNonExistentPackage(t *testing.T) {
	...
	provider := NewGitPackageContentProvider(oackageDir, packageTmpDir, nil, nil)
...
func TestGetAbsolutePathOnDisk_GenericRepositoryDir(t *testing.T) {
	...
	provider := NewGitPackageContentProvider(repositoriesDir, repositoriesTmpDir, nil, nil)
...
func TestGetAbsoluteLocator_SucceedsForRelativeFile(t *testing.T) {
	provider := NewGitPackageContentProvider("", "", nil, nil)
...
func TestCloneReplacedPackagesIfNeeded_Succeeds(t *testing.T) {
	...
	provider := NewGitPackageContentProvider(packageDir, packageTmpDir, enclaveDb, nil)
