...
func (_m *MockPackageContentProvider) GetAbsoluteLocator(packageId string, locatorOfModuleInWhichThisBuiltInIsBeingCalled string, relativeOrAbsoluteLocator string, packageReplaceOptions map[string]string) (*PackageAbsoluteLocator, *startosis_errors.InterpretationError) {
	ret := _m.Called(packageId, locatorOfModuleInWhichThisBuiltInIsBeingCalled, relativeOrAbsoluteLocator, packageReplaceOptions)

	var r0 *PackageAbsoluteLocator
	var r1 *startosis_errors.InterpretationError
	if rf, ok := ret.Get(0).(func(string, string, string, map[string]string) (*PackageAbsoluteLocator, *startosis_errors.InterpretationError)); ok {
		return rf(packageId, locatorOfModuleInWhichThisBuiltInIsBeingCalled, relativeOrAbsoluteLocator, packageReplaceOptions)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, map[string]string) *PackageAbsoluteLocator); ok {
		r0 = rf(packageId, locatorOfModuleInWhichThisBuiltInIsBeingCalled, relativeOrAbsoluteLocator, packageReplaceOptions)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*PackageAbsoluteLocator)
		}
	}
...
// GetModuleContents provides a mock function with given fields: absoluteModuleLocator
func (_m *MockPackageContentProvider) GetModuleContents(absoluteModuleLocator *PackageAbsoluteLocator) (string, *startosis_errors.InterpretationError) {
	ret := _m.Called(absoluteModuleLocator)

	var r0 string
	var r1 *startosis_errors.InterpretationError
	if rf, ok := ret.Get(0).(func(*PackageAbsoluteLocator) (string, *startosis_errors.InterpretationError)); ok {
		return rf(absoluteModuleLocator)
	}
	if rf, ok := ret.Get(0).(func(*PackageAbsoluteLocator) string); ok {
		r0 = rf(absoluteModuleLocator)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(*PackageAbsoluteLocator) *startosis_errors.InterpretationError); ok {
		r1 = rf(absoluteModuleLocator)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*startosis_errors.InterpretationError)
		}
...
//   - absoluteModuleLocator *PackageAbsoluteLocator
func (_e *MockPackageContentProvider_Expecter) GetModuleContents(absoluteModuleLocator interface{}) *MockPackageContentProvider_GetModuleContents_Call {
	return &MockPackageContentProvider_GetModuleContents_Call{Call: _e.mock.On("GetModuleContents", absoluteModuleLocator)}
}

func (_c *MockPackageContentProvider_GetModuleContents_Call) Run(run func(absoluteModuleLocator *PackageAbsoluteLocator)) *MockPackageContentProvider_GetModuleContents_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*PackageAbsoluteLocator))
	})
	return _c
}
...
func (_c *MockPackageContentProvider_GetModuleContents_Call) RunAndReturn(run func(*PackageAbsoluteLocator) (string, *startosis_errors.InterpretationError)) *MockPackageContentProvider_GetModuleContents_Call {
	_c.Call.Return(run)
	return _c
}

// GetOnDiskAbsolutePackageFilePath provides a mock function with given fields: absoluteModuleLocator
func (_m *MockPackageContentProvider) GetOnDiskAbsolutePackageFilePath(absoluteModuleLocator *PackageAbsoluteLocator) (string, *startosis_errors.InterpretationError) {
	ret := _m.Called(absoluteModuleLocator)
...
//   - absoluteModuleLocator *PackageAbsoluteLocator
func (_e *MockPackageContentProvider_Expecter) GetOnDiskAbsolutePackageFilePath(absoluteModuleLocator interface{}) *MockPackageContentProvider_GetOnDiskAbsolutePackageFilePath_Call {
	return &MockPackageContentProvider_GetOnDiskAbsolutePackageFilePath_Call{Call: _e.mock.On("GetOnDiskAbsolutePackageFilePath", absoluteModuleLocator)}
}

func (_c *MockPackageContentProvider_GetOnDiskAbsolutePackageFilePath_Call) Run(run func(absoluteModuleLocator *PackageAbsoluteLocator)) *MockPackageContentProvider_GetOnDiskAbsolutePackageFilePath_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*PackageAbsoluteLocator))
	})
	return _c
...
func (_c *MockPackageContentProvider_GetOnDiskAbsolutePackageFilePath_Call) RunAndReturn(run func(*PackageAbsoluteLocator) (string, *startosis_errors.InterpretationError)) *MockPackageContentProvider_GetOnDiskAbsolutePackageFilePath_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetOnDiskAbsolutePath provides a mock function with given fields: absoluteModuleLocator
func (_m *MockPackageContentProvider) GetOnDiskAbsolutePath(absoluteModuleLocator *PackageAbsoluteLocator) (string, *startosis_errors.InterpretationError) {
	ret := _m.Called(absoluteModuleLocator)
...
//   - absoluteModuleLocator *PackageAbsoluteLocator
func (_e *MockPackageContentProvider_Expecter) GetOnDiskAbsolutePath(absoluteModuleLocator interface{}) *MockPackageContentProvider_GetOnDiskAbsolutePath_Call {
	return &MockPackageContentProvider_GetOnDiskAbsolutePath_Call{Call: _e.mock.On("GetOnDiskAbsolutePath", absoluteModuleLocator)}
}

func (_c *MockPackageContentProvider_GetOnDiskAbsolutePath_Call) Run(run func(absoluteModuleLocator *PackageAbsoluteLocator)) *MockPackageContentProvider_GetOnDiskAbsolutePath_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*PackageAbsoluteLocator))
	})
	return _c
...
func (_c *MockPackageContentProvider_GetOnDiskAbsolutePath_Call) RunAndReturn(run func(*PackageAbsoluteLocator) (string, *startosis_errors.InterpretationError)) *MockPackageContentProvider_GetOnDiskAbsolutePath_Call {
	_c.Call.Return(run)
	return _c
}
...
func NewMockPackageContentProvider(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockPackageContentProvider {
