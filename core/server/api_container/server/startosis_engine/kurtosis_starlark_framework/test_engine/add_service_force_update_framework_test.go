...
type addServiceForceUpdateTestCase struct {
	*testing.T
...
func (suite *KurtosisPlanInstructionTestSuite) TestAddServiceWithForceUpdate() {
	...
	suite.run(&addServiceForceUpdateTestCase{
		T:                            suite.T(),
...
func (t *addServiceForceUpdateTestCase) GetInstruction() *kurtosis_plan_instruction.KurtosisPlanInstruction {
...
func (t *addServiceForceUpdateTestCase) GetStarlarkCode() string {
	...
	return fmt.Sprintf(`%s(%s=%q, %s=%s, %s=%s)`, add_service.AddServiceBuiltinName, add_service.ServiceNameArgName, testServiceName, add_service.ServiceConfigArgName, serviceConfig, add_service.ForceUpdateArgName, "True")
}

func (t *addServiceForceUpdateTestCase) GetStarlarkCodeForAssertion() string {
	return ""
}

func (t *addServiceForceUpdateTestCase) Assert(interpretationResult starlark.Value, executionResult *string) {
