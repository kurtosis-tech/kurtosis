...
func TestAllRegisteredBuiltins(t *testing.T) {
	...
	testKurtosisTypeConstructor(t, newConnectionConfigNoDistributionTestCase(t))
	testKurtosisTypeConstructor(t, newConnectionConfigNormalDistributionTestCase(t))
	testKurtosisTypeConstructor(t, newConnectionConfigUniformDistributionTestCase(t))
