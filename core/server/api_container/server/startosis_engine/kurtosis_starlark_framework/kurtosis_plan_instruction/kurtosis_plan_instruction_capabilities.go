...
type KurtosisPlanInstructionCapabilities interface {
	...
	TryResolveWith(instructionsAreEqual bool, other *enclave_plan.EnclavePlanCapabilities, enclaveComponents *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus

	GetEnclavePlanCapabilities() *enclave_plan.EnclavePlanCapabilities
}
