			...
			Arguments: []*builtin_argument.BuiltinArgument{
				{
					...
					Validator: func(value starlark.Value) *startosis_errors.InterpretationError {
						return builtin_argument.Uint64InRange(value, PacketLossPercentageAttr, 0, 100)
					},
				},
				{
...
func CreateConnectionConfig(packetLossPercentage starlark.Int) (*ConnectionConfig, *startosis_errors.InterpretationError) {
	args := []starlark.Value{
...
func (connectionConfig *ConnectionConfig) ToKurtosisType() (*partition_topology.PartitionConnection, *startosis_errors.InterpretationError) {
	packetLossPctStarlark, found, interpretationErr := kurtosis_type_constructor.ExtractAttrValue[starlark.Float](
