...
//	mockInstruction.EXPECT().TryResolveWith(mock.Anything, mock.Anything).RunAndReturn(func(other kurtosis_instruction.KurtosisInstruction, enclaveComponents *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionType {
//		areEqual := other.String() == instructionName
//		if areEqual {
