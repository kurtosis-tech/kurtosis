...
func (validator *StartosisValidator) Validate(ctx context.Context, instructions []kurtosis_instruction.KurtosisInstruction) <-chan *kurtosis_core_rpc_api_bindings.StarlarkExecutionResponseLine {
	...
	go func() {
		...
		for _, instruction := range instructions {
			...
			if err != nil {
				...
				starlarkExecutionResponseLineStream <- binding_constructors.NewStarlarkExecutionResponseLineFromValidationError(serializedError)
			}
		}
