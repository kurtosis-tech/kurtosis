...
type ScheduledInstruction struct {
	...
	importedFromPreviousEnclaveState bool
...
func (instruction *ScheduledInstruction) ImportedFromPreviousEnclavePlan(isImportedFromPreviousEnclavePlan bool) *ScheduledInstruction {
	instruction.importedFromPreviousEnclaveState = isImportedFromPreviousEnclavePlan
	return instruction
}

func (instruction *ScheduledInstruction) IsImportedFromPreviousEnclavePlan() bool {
	return instruction.importedFromPreviousEnclaveState
}
