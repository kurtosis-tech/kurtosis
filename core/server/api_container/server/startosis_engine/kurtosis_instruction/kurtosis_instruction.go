...
type KurtosisInstruction interface {
	...
	TryResolveWith(other *enclave_plan.EnclavePlanInstruction, enclaveComponents *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus
}
