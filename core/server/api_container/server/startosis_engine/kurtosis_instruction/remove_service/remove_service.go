...
func (builtin *RemoveServiceCapabilities) GetEnclavePlanCapabilities() *enclave_plan.EnclavePlanCapabilities {
	//TODO implement me
	panic("implement me")
}
...
func (builtin *RemoveServiceCapabilities) TryResolveWith(_ bool, _ *enclave_plan.EnclavePlanCapabilities, _ *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus {
