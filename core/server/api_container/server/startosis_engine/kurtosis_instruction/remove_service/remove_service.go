...
func (builtin *RemoveServiceCapabilities) GetEnclavePlanCapabilities() *enclave_plan_capabilities.EnclavePlanCapabilities {
	enclavePlanCapabilitiesBuilder := enclave_plan_capabilities.NewEnclavePlanCapabilitiesBuilder(RemoveServiceBuiltinName)
	enclavePlanCapabilitiesBuilder.WithServiceName(builtin.serviceName)
...
func (builtin *RemoveServiceCapabilities) TryResolveWith(_ bool, _ *enclave_plan_capabilities.EnclavePlanCapabilities, _ *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus {
