...
func (builtin *AddServiceCapabilities) GetEnclavePlanCapabilities() *enclave_plan.EnclavePlanCapabilities {
	enclavePlanCapabilitiesBuilder := enclave_plan.NewEnclavePlanCapabilitiesBuilder(AddServiceBuiltinName)
...
func (builtin *AddServiceCapabilities) TryResolveWith(instructionsAreEqual bool, other *enclave_plan.EnclavePlanCapabilities, enclaveComponents *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus {
