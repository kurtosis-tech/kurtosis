...
// TryResolveWith provides a mock function with given fields: otherKurtosisInstructionStr, other, enclaveComponents
func (_m *MockKurtosisInstruction) TryResolveWith(otherKurtosisInstructionStr string, other kurtosis_instruction.KurtosisInstruction, enclaveComponents *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus {
	ret := _m.Called(otherKurtosisInstructionStr, other, enclaveComponents)

	var r0 enclave_structure.InstructionResolutionStatus
	if rf, ok := ret.Get(0).(func(string, kurtosis_instruction.KurtosisInstruction, *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus); ok {
		r0 = rf(otherKurtosisInstructionStr, other, enclaveComponents)
	} else {
...
//   - otherKurtosisInstructionStr string
//   - other KurtosisInstruction
//   - enclaveComponents *enclave_structure.EnclaveComponents
func (_e *MockKurtosisInstruction_Expecter) TryResolveWith(otherKurtosisInstructionStr interface{}, other interface{}, enclaveComponents interface{}) *MockKurtosisInstruction_TryResolveWith_Call {
	return &MockKurtosisInstruction_TryResolveWith_Call{Call: _e.mock.On("TryResolveWith", otherKurtosisInstructionStr, other, enclaveComponents)}
}

func (_c *MockKurtosisInstruction_TryResolveWith_Call) Run(run func(otherKurtosisInstructionStr string, other kurtosis_instruction.KurtosisInstruction, enclaveComponents *enclave_structure.EnclaveComponents)) *MockKurtosisInstruction_TryResolveWith_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(kurtosis_instruction.KurtosisInstruction), args[2].(*enclave_structure.EnclaveComponents))
	})
	return _c
}
...
func (_c *MockKurtosisInstruction_TryResolveWith_Call) RunAndReturn(run func(string, kurtosis_instruction.KurtosisInstruction, *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus) *MockKurtosisInstruction_TryResolveWith_Call {
	_c.Call.Return(run)
	return _c
}
