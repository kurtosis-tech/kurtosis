...
func (_m *MockKurtosisInstruction) TryResolveWith(other kurtosis_instruction.EnclavePlanInstruction, enclaveComponents *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus {
	ret := _m.Called(other, enclaveComponents)

	var r0 enclave_structure.InstructionResolutionStatus
	if rf, ok := ret.Get(0).(func(kurtosis_instruction.EnclavePlanInstruction, *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus); ok {
...
func (_c *MockKurtosisInstruction_TryResolveWith_Call) Run(run func(other kurtosis_instruction.EnclavePlanInstruction, enclaveComponents *enclave_structure.EnclaveComponents)) *MockKurtosisInstruction_TryResolveWith_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(kurtosis_instruction.EnclavePlanInstruction), args[1].(*enclave_structure.EnclaveComponents))
	})
	return _c
}
...
func (_c *MockKurtosisInstruction_TryResolveWith_Call) RunAndReturn(run func(kurtosis_instruction.EnclavePlanInstruction, *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus) *MockKurtosisInstruction_TryResolveWith_Call {
	_c.Call.Return(run)
	return _c
}
