...
func (_m *MockKurtosisInstruction) Hash() string {
	ret := _m.Called()
...
// MockKurtosisInstruction_Hash_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Hash'
type MockKurtosisInstruction_Hash_Call struct {
	*mock.Call
}

// Hash is a helper method to define mock.On call
func (_e *MockKurtosisInstruction_Expecter) Hash() *MockKurtosisInstruction_Hash_Call {
	return &MockKurtosisInstruction_Hash_Call{Call: _e.mock.On("Hash")}
}

func (_c *MockKurtosisInstruction_Hash_Call) Run(run func()) *MockKurtosisInstruction_Hash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockKurtosisInstruction_Hash_Call) Return(_a0 string) *MockKurtosisInstruction_Hash_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockKurtosisInstruction_Hash_Call) RunAndReturn(run func() string) *MockKurtosisInstruction_Hash_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockKurtosisInstruction) Uuid() kurtosis_starlark_framework.InstructionUuid {
	ret := _m.Called()

	var r0 kurtosis_starlark_framework.InstructionUuid
	if rf, ok := ret.Get(0).(func() kurtosis_starlark_framework.InstructionUuid); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(kurtosis_starlark_framework.InstructionUuid)
	}

	return r0
}

// MockKurtosisInstruction_Uuid_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Uuid'
type MockKurtosisInstruction_Uuid_Call struct {
	*mock.Call
}

// Uuid is a helper method to define mock.On call
func (_e *MockKurtosisInstruction_Expecter) Uuid() *MockKurtosisInstruction_Uuid_Call {
	return &MockKurtosisInstruction_Uuid_Call{Call: _e.mock.On("Uuid")}
}

func (_c *MockKurtosisInstruction_Uuid_Call) Run(run func()) *MockKurtosisInstruction_Uuid_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockKurtosisInstruction_Uuid_Call) Return(_a0 kurtosis_starlark_framework.InstructionUuid) *MockKurtosisInstruction_Uuid_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockKurtosisInstruction_Uuid_Call) RunAndReturn(run func() kurtosis_starlark_framework.InstructionUuid) *MockKurtosisInstruction_Uuid_Call {
	_c.Call.Return(run)
	return _c
}
