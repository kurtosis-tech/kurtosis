...
func (_m *MockKurtosisInstruction) TryResolveWith(other kurtosis_instruction.KurtosisInstruction, enclaveComponents *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionType {
	ret := _m.Called(other, enclaveComponents)

	var r0 enclave_structure.InstructionResolutionType
	if rf, ok := ret.Get(0).(func(kurtosis_instruction.KurtosisInstruction, *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionType); ok {
		r0 = rf(other, enclaveComponents)
	} else {
		r0 = ret.Get(0).(enclave_structure.InstructionResolutionType)
	}
...
func (_c *MockKurtosisInstruction_TryResolveWith_Call) Return(_a0 enclave_structure.InstructionResolutionType) *MockKurtosisInstruction_TryResolveWith_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockKurtosisInstruction_TryResolveWith_Call) RunAndReturn(run func(kurtosis_instruction.KurtosisInstruction, *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionType) *MockKurtosisInstruction_TryResolveWith_Call {
	_c.Call.Return(run)
	return _c
}
