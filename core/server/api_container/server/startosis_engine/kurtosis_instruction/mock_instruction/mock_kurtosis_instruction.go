...
import (
	...
	builtin_argument "github.com/kurtosis-tech/kurtosis/core/server/api_container/server/startosis_engine/kurtosis_starlark_framework/builtin_argument"
...
func (_m *MockKurtosisInstruction) GetArguments() *builtin_argument.ArgumentValuesSet {
	ret := _m.Called()

	var r0 *builtin_argument.ArgumentValuesSet
	if rf, ok := ret.Get(0).(func() *builtin_argument.ArgumentValuesSet); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*builtin_argument.ArgumentValuesSet)
		}
	}
...
// MockKurtosisInstruction_GetArguments_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetArguments'
type MockKurtosisInstruction_GetArguments_Call struct {
	*mock.Call
}

// GetArguments is a helper method to define mock.On call
func (_e *MockKurtosisInstruction_Expecter) GetArguments() *MockKurtosisInstruction_GetArguments_Call {
	return &MockKurtosisInstruction_GetArguments_Call{Call: _e.mock.On("GetArguments")}
}
...
func (_c *MockKurtosisInstruction_GetArguments_Call) Return(_a0 *builtin_argument.ArgumentValuesSet) *MockKurtosisInstruction_GetArguments_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockKurtosisInstruction_GetArguments_Call) RunAndReturn(run func() *builtin_argument.ArgumentValuesSet) *MockKurtosisInstruction_GetArguments_Call {
	_c.Call.Return(run)
	return _c
}
