...
type MockKurtosisInstruction_ExecuteWithStreamedOutput_Call struct {
	*mock.Call
}

// ExecuteWithStreamedOutput is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockKurtosisInstruction_Expecter) ExecuteWithStreamedOutput(ctx interface{}) *MockKurtosisInstruction_ExecuteWithStreamedOutput_Call {
	return &MockKurtosisInstruction_ExecuteWithStreamedOutput_Call{Call: _e.mock.On("ExecuteWithStreamedOutput", ctx)}
}

func (_c *MockKurtosisInstruction_ExecuteWithStreamedOutput_Call) Run(run func(ctx context.Context)) *MockKurtosisInstruction_ExecuteWithStreamedOutput_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
