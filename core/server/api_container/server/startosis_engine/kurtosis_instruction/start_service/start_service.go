...
func (builtin *StartServiceCapabilities) GetPersistableAttributes() (string, []string, []string, []string) {
	return StartServiceBuiltinName, []string{string(builtin.serviceName)}, []string{}, []string{}
}
