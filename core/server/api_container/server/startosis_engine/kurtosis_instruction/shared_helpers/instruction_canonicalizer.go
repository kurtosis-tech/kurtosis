...
func CanonicalizeArgValue(genericArgValue starlark.Value) string {
	...
	case *kurtosis_types.ConnectionConfig, *recipe.ExecRecipe, *recipe.HttpRequestRecipe, *kurtosis_types.PortSpec, *kurtosis_types.Service, *kurtosis_types.ServiceConfig, *kurtosis_types.UpdateServiceConfig:
		stringifiedArg = argValue.String()
	case time.Time:
