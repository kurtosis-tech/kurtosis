...
func (builtin *RemoveConnectionCapabilities) ExecuteWithStreamedOutput(ctx context.Context, _ *builtin_argument.ArgumentValuesSet) (<-chan string, chan string, error) {
	return nil, nil, nil
}
