...
func (builtin *SetConnectionCapabilities) ExecuteWithStreamedOutput(ctx context.Context, _ *builtin_argument.ArgumentValuesSet) (<-chan string, chan string, error) {
	return nil, nil, nil
}
