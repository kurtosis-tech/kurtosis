...
func (builtin *StopServiceCapabilities) GetPersistableAttributes() (string, []string, []string, [][]byte) {
	return StopServiceBuiltinName, []string{string(builtin.serviceName)}, []string{}, [][]byte{}
}
