...
func (builtin *StopServiceCapabilities) GetEnclavePlanCapabilities() *enclave_plan.EnclavePlanCapabilities {
	//TODO implement me
	panic("implement me")
}
...
func (builtin *StopServiceCapabilities) TryResolveWith(_ bool, _ *enclave_plan.EnclavePlanCapabilities, _ *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus {
