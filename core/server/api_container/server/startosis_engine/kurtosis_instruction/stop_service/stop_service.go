...
func (builtin *StopServiceCapabilities) GetEnclavePlanCapabilities() *enclave_plan_capabilities.EnclavePlanCapabilities {
	enclavePlanCapabilitiesBuilder := enclave_plan_capabilities.NewEnclavePlanCapabilitiesBuilder(StopServiceBuiltinName)
...
func (builtin *StopServiceCapabilities) TryResolveWith(_ bool, _ *enclave_plan_capabilities.EnclavePlanCapabilities, _ *enclave_structure.EnclaveComponents) enclave_structure.InstructionResolutionStatus {
