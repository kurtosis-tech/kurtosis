...
func getCompressedPythonScriptForUpload(pythonScript string) ([]byte, []byte, *startosis_errors.InterpretationError) {
	...
	compressed, contentMd5, err := shared_utils.CompressPath(pythonScriptFilePath, enforceMaxSizeLimit)
	if err != nil {
