...
//TODO this should be removed and we should use service.ServiceID from container-engine-lib instead
...
//TODO this should be removed and we should use service.ServiceGUID from container-engine-lib instead
