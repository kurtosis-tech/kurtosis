...
import (
	...
	enclave_data_directory "github.com/dzobbe/PoTE-kurtosis/core/server/commons/enclave_data_directory"
	...
	render_templates "github.com/dzobbe/PoTE-kurtosis/core/server/api_container/server/service_network/render_templates"

	service "github.com/dzobbe/PoTE-kurtosis/container-engine-lib/lib/backend_interface/objects/service"

	service_identifiers "github.com/dzobbe/PoTE-kurtosis/core/server/api_container/server/service_network/service_identifiers"
)
...
func (_m *MockServiceNetwork) HttpRequestService(ctx context.Context, _a1 *service.Service, portId string, method string, contentType string, endpoint string, body string, header map[string]string) (*http.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *service.Service, string, string, string, string, string, map[string]string) (*http.Response, error)); ok {
		return rf(ctx, _a1, portId, method, contentType, endpoint, body, header)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *service.Service, string, string, string, string, string, map[string]string) *http.Response); ok {
		r0 = rf(ctx, _a1, portId, method, contentType, endpoint, body, header)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *service.Service, string, string, string, string, string, map[string]string) error); ok {
		r1 = rf(ctx, _a1, portId, method, contentType, endpoint, body, header)
	} else {
		r1 = ret.Error(1)
	}
