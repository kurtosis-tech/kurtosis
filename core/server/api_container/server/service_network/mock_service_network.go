...
// MockServiceNetwork_StartAllServices_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StartAllServices'
type MockServiceNetwork_StartAllServices_Call struct {
	*mock.Call
}
...
func (_c *MockServiceNetwork_StartAllServices_Call) Return(_a0 error) *MockServiceNetwork_StartAllServices_Call {
	_c.Call.Return(_a0)
	return _c
}
