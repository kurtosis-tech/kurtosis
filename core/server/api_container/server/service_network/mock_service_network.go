...
// UpdateFilesArtifact provides a mock function with given fields: updatedContent, contentMd5, artifactName
func (_m *MockServiceNetwork) UpdateFilesArtifact(updatedContent []byte, contentMd5 []byte, artifactName string) (enclave_data_directory.FilesArtifactUUID, error) {
	ret := _m.Called(updatedContent, contentMd5, artifactName)

	var r0 enclave_data_directory.FilesArtifactUUID
	var r1 error
	if rf, ok := ret.Get(0).(func([]byte, []byte, string) (enclave_data_directory.FilesArtifactUUID, error)); ok {
		return rf(updatedContent, contentMd5, artifactName)
	}
	if rf, ok := ret.Get(0).(func([]byte, []byte, string) enclave_data_directory.FilesArtifactUUID); ok {
		r0 = rf(updatedContent, contentMd5, artifactName)
	} else {
		r0 = ret.Get(0).(enclave_data_directory.FilesArtifactUUID)
	}

	if rf, ok := ret.Get(1).(func([]byte, []byte, string) error); ok {
		r1 = rf(updatedContent, contentMd5, artifactName)
	} else {
		r1 = ret.Error(1)
	}
...
//   - contentMd5 []byte
//   - artifactName string
func (_e *MockServiceNetwork_Expecter) UpdateFilesArtifact(updatedContent interface{}, contentMd5 interface{}, artifactName interface{}) *MockServiceNetwork_UpdateFilesArtifact_Call {
	return &MockServiceNetwork_UpdateFilesArtifact_Call{Call: _e.mock.On("UpdateFilesArtifact", updatedContent, contentMd5, artifactName)}
}

func (_c *MockServiceNetwork_UpdateFilesArtifact_Call) Run(run func(updatedContent []byte, contentMd5 []byte, artifactName string)) *MockServiceNetwork_UpdateFilesArtifact_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]byte), args[1].([]byte), args[2].(string))
	})
	return _c
}

func (_c *MockServiceNetwork_UpdateFilesArtifact_Call) Return(_a0 enclave_data_directory.FilesArtifactUUID, _a1 error) *MockServiceNetwork_UpdateFilesArtifact_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockServiceNetwork_UpdateFilesArtifact_Call) RunAndReturn(run func([]byte, []byte, string) (enclave_data_directory.FilesArtifactUUID, error)) *MockServiceNetwork_UpdateFilesArtifact_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockServiceNetwork_UpdateServiceSubnetwork_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateServiceSubnetwork'
type MockServiceNetwork_UpdateServiceSubnetwork_Call struct {
	*mock.Call
}

// UpdateServiceSubnetwork is a helper method to define mock.On call
//   - ctx context.Context
//   - updateServiceConfigs map[service.ServiceName]*kurtosis_core_rpc_api_bindings.UpdateServiceConfig
func (_e *MockServiceNetwork_Expecter) UpdateServiceSubnetwork(ctx interface{}, updateServiceConfigs interface{}) *MockServiceNetwork_UpdateServiceSubnetwork_Call {
	return &MockServiceNetwork_UpdateServiceSubnetwork_Call{Call: _e.mock.On("UpdateServiceSubnetwork", ctx, updateServiceConfigs)}
}

func (_c *MockServiceNetwork_UpdateServiceSubnetwork_Call) Run(run func(ctx context.Context, updateServiceConfigs map[service.ServiceName]*kurtosis_core_rpc_api_bindings.UpdateServiceConfig)) *MockServiceNetwork_UpdateServiceSubnetwork_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockServiceNetwork_UpdateServiceSubnetwork_Call) Return(_a0 map[service.ServiceName]bool, _a1 map[service.ServiceName]error, _a2 error) *MockServiceNetwork_UpdateServiceSubnetwork_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockServiceNetwork_UpdateServiceSubnetwork_Call) RunAndReturn(run func(context.Context, map[service.ServiceName]*kurtosis_core_rpc_api_bindings.UpdateServiceConfig) (map[service.ServiceName]bool, map[service.ServiceName]error, error)) *MockServiceNetwork_UpdateServiceSubnetwork_Call {
	_c.Call.Return(run)
	return _c
}
...
// UploadFilesArtifact provides a mock function with given fields: content, contentMd5, artifactName
func (_m *MockServiceNetwork) UploadFilesArtifact(content []byte, contentMd5 []byte, artifactName string) (enclave_data_directory.FilesArtifactUUID, error) {
	ret := _m.Called(content, contentMd5, artifactName)

	var r0 enclave_data_directory.FilesArtifactUUID
	var r1 error
	if rf, ok := ret.Get(0).(func([]byte, []byte, string) (enclave_data_directory.FilesArtifactUUID, error)); ok {
		return rf(content, contentMd5, artifactName)
	}
	if rf, ok := ret.Get(0).(func([]byte, []byte, string) enclave_data_directory.FilesArtifactUUID); ok {
		r0 = rf(content, contentMd5, artifactName)
	} else {
		r0 = ret.Get(0).(enclave_data_directory.FilesArtifactUUID)
	}

	if rf, ok := ret.Get(1).(func([]byte, []byte, string) error); ok {
		r1 = rf(content, contentMd5, artifactName)
	} else {
		r1 = ret.Error(1)
	}
...
//   - contentMd5 []byte
//   - artifactName string
func (_e *MockServiceNetwork_Expecter) UploadFilesArtifact(content interface{}, contentMd5 interface{}, artifactName interface{}) *MockServiceNetwork_UploadFilesArtifact_Call {
	return &MockServiceNetwork_UploadFilesArtifact_Call{Call: _e.mock.On("UploadFilesArtifact", content, contentMd5, artifactName)}
}

func (_c *MockServiceNetwork_UploadFilesArtifact_Call) Run(run func(content []byte, contentMd5 []byte, artifactName string)) *MockServiceNetwork_UploadFilesArtifact_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]byte), args[1].([]byte), args[2].(string))
	})
	return _c
...
func (_c *MockServiceNetwork_UploadFilesArtifact_Call) RunAndReturn(run func([]byte, []byte, string) (enclave_data_directory.FilesArtifactUUID, error)) *MockServiceNetwork_UploadFilesArtifact_Call {
	_c.Call.Return(run)
	return _c
}
...
func NewMockServiceNetwork(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockServiceNetwork {
