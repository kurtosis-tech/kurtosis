...
// GetServiceNameToPrivatePortIdsMap provides a mock function with given fields:
func (_m *MockServiceNetwork) GetServiceNameToPrivatePortIdsMap() (map[service.ServiceName][]string, error) {
	ret := _m.Called()

	var r0 map[service.ServiceName][]string
	var r1 error
	if rf, ok := ret.Get(0).(func() (map[service.ServiceName][]string, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() map[service.ServiceName][]string); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[service.ServiceName][]string)
		}
	}
...
// MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetServiceNameToPrivatePortIdsMap'
type MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call struct {
	*mock.Call
}

// GetServiceNameToPrivatePortIdsMap is a helper method to define mock.On call
func (_e *MockServiceNetwork_Expecter) GetServiceNameToPrivatePortIdsMap() *MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call {
	return &MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call{Call: _e.mock.On("GetServiceNameToPrivatePortIdsMap")}
}

func (_c *MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call) Run(run func()) *MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call) Return(_a0 map[service.ServiceName][]string, _a1 error) *MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call) RunAndReturn(run func() (map[service.ServiceName][]string, error)) *MockServiceNetwork_GetServiceNameToPrivatePortIdsMap_Call {
	_c.Call.Return(run)
	return _c
}
