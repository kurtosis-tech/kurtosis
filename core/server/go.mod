...
require (
	...
	github.com/kurtosis-tech/kurtosis/api/golang v1.16.6 // Local dependency
...
require (
	...
	github.com/kurtosis-tech/kurtosis/path-compression v0.0.0-20260317111349-a92a4b107a1a
