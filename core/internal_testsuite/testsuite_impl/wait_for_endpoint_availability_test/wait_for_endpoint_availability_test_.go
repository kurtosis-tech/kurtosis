...
func (test WaitForEndpointAvailabilityTest) Run(network networks.Network) error {
	...
	if err := castedNetworkContext.WaitForEndpointAvailability(datastoreServiceId, 0, port, healthCheckUrlSlug, waitInitialDelaySeconds, waitForStartupMaxPolls, waitForStartupTimeBetweenPolls, healthyValue); err != nil {
