...
func (c *WebServer) IsNewKurtosisVersionAvailable(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.Response[kurtosis_backend_server_rpc_api_bindings.IsNewKurtosisVersionAvailableResponse], error) {
	...
	isNewKurtosisVersionAvailableRequest := &connect.Request[kurtosis_backend_server_rpc_api_bindings.IsNewKurtosisVersionAvailableRequest]{
		Msg: &kurtosis_backend_server_rpc_api_bindings.IsNewKurtosisVersionAvailableRequest{
			...
			AccessToken:            "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlRYd2VsWUxSNmF2blVnMFdWVThBciJ9..ZCy59243uWQG6L9Fnd7eeAb39HyRjZ6YCjaIEZX-HrdUQ44wgDId_COXez_3iD_nuajxtpmTHWVrNV4uxf4JJh6WmiPS1AUyCoDOYgv8VStaiR-e4VB4DLd1hMhGEKKJtKSzHtyhLHqbcK_S21soS3Uas77n8efmXJ7AJBUnRRlxeKUJhWP46ZhwFnycisnc4d6pERaNfMG4tPSMXXmbzN2gnG_CSh3Gh-pC4B8MAUMxSCzAuXnFGInezhR2wHaKzsfiz-X6kcGmkYEPAuphOHkaWEPyMsxgxciSIbDLHe8Nv0n23LHJug9tVCs_1gHv0uKDmXlLWUJ8vuwTRbKUzw",
