...
export const enclavesLoader = async (): Promise<Result<EnclaveFullInfo[], string>> => {
...
export const EnclaveList = () => {
  const maybeEnclaves = useRouteLoaderData("enclaves") as Awaited<ReturnType<typeof enclavesLoader>>;
