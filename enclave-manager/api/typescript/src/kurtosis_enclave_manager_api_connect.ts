...
export const KurtosisEnclaveManagerServer = {
  ...
  methods: {
    ...
    /**
     * @generated from rpc kurtosis_enclave_manager.KurtosisEnclaveManagerServer.GetEnclavesByUuids
     */
    getEnclavesByUuids: {
      name: "GetEnclavesByUuids",
      I: GetEnclavesByUuidsRequest,
      O: GetEnclavesResponse,
      kind: MethodKind.Unary,
    },
    /**
