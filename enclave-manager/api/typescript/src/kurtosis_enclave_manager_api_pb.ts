...
/**
 * @generated from message kurtosis_enclave_manager.PublishPackageRequest
 */
export class PublishPackageRequest extends Message<PublishPackageRequest> {
  /**
  ...
  /**
   * @generated from field: string packageName = 2;
   */
  packageName = "";

  /**
   * @generated from field: string serializedStarlarkScript = 3;
   */
  serializedStarlarkScript = "";

  /**
   * @generated from field: bytes serializedPackageIcon = 4;
   */
  serializedPackageIcon = new Uint8Array(0);

  constructor(data?: PartialMessage<PublishPackageRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "kurtosis_enclave_manager.PublishPackageRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "authCode", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "packageName", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "serializedStarlarkScript", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "serializedPackageIcon", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PublishPackageRequest {
    return new PublishPackageRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PublishPackageRequest {
    return new PublishPackageRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PublishPackageRequest {
    return new PublishPackageRequest().fromJsonString(jsonString, options);
  }

  static equals(a: PublishPackageRequest | PlainMessage<PublishPackageRequest> | undefined, b: PublishPackageRequest | PlainMessage<PublishPackageRequest> | undefined): boolean {
    return proto3.util.equals(PublishPackageRequest, a, b);
  }
}
