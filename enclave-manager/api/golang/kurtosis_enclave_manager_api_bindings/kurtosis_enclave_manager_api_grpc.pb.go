...
const (
	...
	KurtosisEnclaveManagerServer_PublishPackageRepository_FullMethodName       = "/kurtosis_enclave_manager.KurtosisEnclaveManagerServer/PublishPackageRepository"
)
...
type KurtosisEnclaveManagerServerClient interface {
	...
	PublishPackageRepository(ctx context.Context, in *PublishPackageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *kurtosisEnclaveManagerServerClient) PublishPackageRepository(ctx context.Context, in *PublishPackageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, KurtosisEnclaveManagerServer_PublishPackageRepository_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KurtosisEnclaveManagerServerServer interface {
	...
	PublishPackageRepository(context.Context, *PublishPackageRequest) (*emptypb.Empty, error)
}
...
func (UnimplementedKurtosisEnclaveManagerServerServer) PublishPackageRepository(context.Context, *PublishPackageRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PublishPackageRepository not implemented")
}
...
func _KurtosisEnclaveManagerServer_PublishPackageRepository_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PublishPackageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KurtosisEnclaveManagerServerServer).PublishPackageRepository(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KurtosisEnclaveManagerServer_PublishPackageRepository_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KurtosisEnclaveManagerServerServer).PublishPackageRepository(ctx, req.(*PublishPackageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KurtosisEnclaveManagerServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PublishPackageRepository",
			Handler:    _KurtosisEnclaveManagerServer_PublishPackageRepository_Handler,
		},
	},
