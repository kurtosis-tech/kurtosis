...
func TestStartosisPackage_ValidPackageWithInput_MissingKeyInParams(t *testing.T) {
	...
	runResult, _ := enclaveCtx.RunStarlarkPackageBlocking(ctx, moduleDirpath, useDefaultMainFile, useDefaultFunctionName, params, defaultDryRun, defaultParallelism, noExperimentalFeature)
