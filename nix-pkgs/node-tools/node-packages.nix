...
let
  sources = {
    "@bufbuild/protobuf-1.8.0" = {
      ...
      version = "1.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@bufbuild/protobuf/-/protobuf-1.8.0.tgz";
        sha512 = "qR9FwI8QKIveDnUYutvfzbC21UZJJryYrLuZGjeZ/VGz+vXelUkK+xgkOHsvPEdYEdxtgUUq4313N8QtOehJ1Q==";
      };
    };
    "@bufbuild/protoc-gen-es-1.8.0" = {
      ...
      version = "1.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@bufbuild/protoc-gen-es/-/protoc-gen-es-1.8.0.tgz";
        sha512 = "jnvBKwHq3o/iOgfKxaxn5Za7ay4oAs8KWgoHiDc9Fsb0g+/d1z+mHlHvmevOiCPcVZsnH6V3LImOJvGStPONpA==";
      };
    };
    "@bufbuild/protoplugin-1.8.0" = {
      ...
      version = "1.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@bufbuild/protoplugin/-/protoplugin-1.8.0.tgz";
        sha512 = "Pb89cTshW+I577qh27VvxGYvZEvQ3zJ8La1OfzPCKugP9d4A4P65WStkAY+aSCiDHk68m1/+mtBb6elfiLPuFg==";
      };
    };
    "@connectrpc/connect-1.4.0" = {
      ...
      version = "1.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@connectrpc/connect/-/connect-1.4.0.tgz";
        sha512 = "vZeOkKaAjyV4+RH3+rJZIfDFJAfr+7fyYr6sLDKbYX3uuTVszhFe9/YKf5DNqrDb5cKdKVlYkGn6DTDqMitAnA==";
      };
    };
    "@connectrpc/protoc-gen-connect-es-1.4.0" = {
      ...
      version = "1.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@connectrpc/protoc-gen-connect-es/-/protoc-gen-connect-es-1.4.0.tgz";
        sha512 = "/7vQ8Q7mEBhV8qEVh/eifRQlQnf8EJ6weMwCD2DljVAQRlZYcW9SLxjYZhV1uM1ZZqQC7Cw2vvgXRg2XQswHBg==";
      };
    };
    "@redocly/ajv-8.11.0" = {
    ...
    "@redocly/config-0.2.0" = {
      ...
      version = "0.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@redocly/config/-/config-0.2.0.tgz";
        sha512 = "r0TqTPVXrxdvhpbOntWnJofOx0rC7u+A+tfC0KFwMtw38QCNb3pwodVjeLa7MT5Uu+fcPxfO119yLBj0QHvBuQ==";
      };
    };
    "@redocly/openapi-core-1.11.0" = {
      ...
      version = "1.11.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@redocly/openapi-core/-/openapi-core-1.11.0.tgz";
        sha512 = "VH10SAkDu+jVW9tDFJWWYroFxHVY9N5VS4gorXw0cK8L+LydUOQ4KiZaKbTsTF2piWmZCxngZI7sNPHMiJ4Ftg==";
      };
    };
    ...
    "openapi-fetch-0.8.2" = {
      ...
      version = "0.8.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/openapi-fetch/-/openapi-fetch-0.8.2.tgz";
        sha512 = "4g+NLK8FmQ51RW6zLcCBOVy/lwYmFJiiT+ckYZxJWxUxH4XFhsNcX2eeqVMfVOi+mDNFja6qDXIZAz2c5J/RVw==";
      };
    };
    "openapi-typescript-7.0.0-next.5" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/openapi-typescript/-/openapi-typescript-7.0.0-next.5.tgz";
        sha512 = "zqEDw/FZkT0ndOCd8EybkDVwEYgaOh+ryWm6OCON70DmY9YqUnNSIVyRFVjN8hesa0bxOs9QOMzXAasczNdHbQ==";
      };
    };
    "openapi-typescript-helpers-0.0.5" = {
      ...
      version = "0.0.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/openapi-typescript-helpers/-/openapi-typescript-helpers-0.0.5.tgz";
        sha512 = "MRffg93t0hgGZbYTxg60hkRIK2sRuEOHEtCUgMuLgbCC33TMQ68AmxskzUlauzZYD47+ENeGV/ElI7qnWqrAxA==";
      };
    };
    "pluralize-8.0.0" = {
      name = "pluralize";
  ...
  args = {
    ...
    src = ./.;
    dependencies = [
      sources."@bufbuild/protobuf-1.8.0"
      sources."@bufbuild/protoc-gen-es-1.8.0"
      sources."@bufbuild/protoplugin-1.8.0"
      sources."@connectrpc/connect-1.4.0"
      sources."@connectrpc/protoc-gen-connect-es-1.4.0"
      sources."@redocly/ajv-8.11.0"
      sources."@redocly/config-0.2.0"
      sources."@redocly/openapi-core-1.11.0"
