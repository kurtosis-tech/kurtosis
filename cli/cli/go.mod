...
require (
	...
	github.com/kurtosis-tech/metrics-library/golang v0.0.0-20220131141354-b806f8c0382b //TODO replace with a new release version that contains metrics library
