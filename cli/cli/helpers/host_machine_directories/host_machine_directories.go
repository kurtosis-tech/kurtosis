...
const (
	...
	kurtosisClusterSettingYAMLFilename = "cluster-setting.yml"
...
func GetKurtosisClusterSettingYAMLFilepath() (string, error) {
	xdgRelFilepath := getRelativeFilepathForXDG(kurtosisClusterSettingYAMLFilename)
