...
// 	runFinishedEvent := binding_constructors.NewStarlarkRunResponseLineFromRunSuccessEvent(``, testDuration, 0).GetRunFinishedEvent()
...
// 	runFinishedEvent := binding_constructors.NewStarlarkRunResponseLineFromRunSuccessEvent(`{"hello": "world"}`, testDuration, 0).GetRunFinishedEvent()
// 	message := formatRunOutput(runFinishedEvent, dryRun, defaultVerbosity)
