...
type KurtosisConfigV6 struct {
	...
	KurtosisClusters  map[string]*KurtosisClusterConfigV6 `yaml:"kurtosis-clusters,omitempty"`
	CloudConfig       *KurtosisCloudConfigV6              `yaml:"cloud-config,omitempty"`
}
