...
type KurtosisConfigV8 struct {
	...
	KurtosisClusters  map[string]*KurtosisClusterConfigV8 `yaml:"kurtosis-clusters,omitempty"`
	CloudConfig       *KurtosisCloudConfigV8              `yaml:"cloud-config,omitempty"`
}
