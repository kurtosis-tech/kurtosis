	...
	Flags: []*flags.FlagConfig{
		...
		},
		{
			...
			Usage: fmt.Sprintf(
				...
				module_image_name_generator.AllowedEnclaveIdCharsRegexStr,
			),
			Type:    flags.FlagType_String,
...
func run(
	...
	err = module_image_name_generator.ValidateImageName(enclaveIdStr)
	if err != nil {
...
func getImageNameWithUnixTimestamp(moduleImage string) string {
	enclaveId := module_image_name_generator.NewAutogeneratedImageName()
