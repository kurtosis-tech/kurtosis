...
func run(
	...
	// NOTE(tedi  04/03/25) If your wondering why the grafana / loki instance is being started by the CLI (and not in container-engine-lib via KurtosisBackend as with LogsCollector and LogsAggregator), this is why:
	...
	// 3. having grafloki started/managed by the CLI lets us reuse export logs feature
	var lokiHost string
