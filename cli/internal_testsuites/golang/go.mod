...
replace (
	github.com/kurtosis-tech/kurtosis-core/api/golang => ../../../kurtosis-core/api/golang
	github.com/kurtosis-tech/kurtosis-engine-server/api/golang => ../../../kurtosis-engine-server/api/golang
)
