...
UPDATE_OWN_VERSION_SCRIPT_FILENAME="update-own-version-constants.sh"


# ==================================================================================================
#                                             Main Logic
# ==================================================================================================
if ! bash "${RELEASE_SCRIPT_FILENAME}" "${root_dirpath}" "${script_dirpath}/${UPDATE_OWN_VERSION_SCRIPT_FILENAME}"; then
