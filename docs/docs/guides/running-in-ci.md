...
II. Start The Engine
----------------------------
You'll need the Kurtosis engine to be running to interact with Kurtosis, both for the [CLI](../cli-reference/index.md) and [using the client libraries](../client-libs-reference). Add `kurtosis engine start` in your CI config file after the CLI installation commands so that your Kurtosis commands work.
