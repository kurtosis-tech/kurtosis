...
1. The `--with-subnetworks` flag can be used to enable [subnetwork capabilties](../reference/subnetworks.md) within the specified enclave that the script or package is instructed to run within. This flag is false by default.
