...
<details><summary>Review: Hello World</summary>
...
<details><summary>Review: Run Postgres</summary>
...
<details><summary>Review: Add some data</summary>
...
<details><summary>Review: Add an API</summary>
...
<details><summary>Review: Modifying data</summary>
How did this work?
...
Conclusion
----------
And that's it - you've written your very first package in Kurtosis! You experienced number of workflows that Kurtosis optimizes to help make setting up an environment easy for your package users. Namely, you:
