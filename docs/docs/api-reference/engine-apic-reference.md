...
Gets relevant information about services (identified by the given service [service-identifiers][identifiers]) that are running in the enclave.

**Args**

* `serviceIdentifiers`: The [ServiceIdentifiers][service-identifiers] to indicate which services to retrieve.
