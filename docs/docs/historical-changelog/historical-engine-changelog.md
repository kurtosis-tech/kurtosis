...
* Upgraded to Kurtosis Core 1.45.0
    * Users should follow the changes [described in the changelog](./historical-core-changelog.md)
...
* The `EnclaveContext` has been modified fairly significantly; for a list of breaking changes and remediations see [the 1.44.0 docs](./historical-core-changelog.md)
...
* Upgraded to kurtosis-core 1.36.0, which changes the way partition connection information is defined during repartitioning
  * Users should see [the Kurtosis Core changelog on the topic](./historical-core-changelog.md#breaking-changes) and implement the remediation there
