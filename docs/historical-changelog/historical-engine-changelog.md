...
These changelogs are from a time when `kurtosis-engine-server` was its own repo. This isn't
...
# 1.34.4
### Fixes
- Upgrade to container-engine-lib to 0.38.4 and core 1.59.5 to fix another bug with port selection 
...
# 1.34.2
### Changes
* Upgraded core to 1.59.3 and container-engine-lib to 0.38.2
...
* Upgrade container-engine-lib 0.33.1
...
# 1.22.7
### Changes
* Upgraded to container-engine-lib 0.30.2 and Core 1.50.7

# 1.22.6
### Changes
* Upgraded to container-engine-lib 0.30.1 and Core 1.50.6
...
* Upgraded to Kurtosis Core 1.45.0
    * Users should follow the changes [described in the changelog](https://kurtosis-tech.github.io/kurtosis/historical-changelog/historical-core-changelog)
...
* The `EnclaveContext` has been modified fairly significantly; for a list of breaking changes and remediations see [the 1.44.0 docs](https://kurtosis-tech.github.io/kurtosis/historical-changelog/historical-core-changelog)
...
* Upgraded to kurtosis-core 1.36.0, which changes the way partition connection information is defined during repartitioning
  * Users should see [the Kurtosis Core changelog on the topic](https://kurtosis-tech.github.io/kurtosis/historical-changelog/historical-core-changelog#breaking-changes) and implement the remediation there
