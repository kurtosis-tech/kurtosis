...
const (
	...
	KurtosisCloudBackendServer_DeleteInstances_FullMethodName               = "/kurtosis_cloud.KurtosisCloudBackendServer/DeleteInstances"
	...
	KurtosisCloudBackendServer_GetInstanceMetrics_FullMethodName            = "/kurtosis_cloud.KurtosisCloudBackendServer/GetInstanceMetrics"
)
...
func (c *kurtosisCloudBackendServerClient) DeleteInstances(ctx context.Context, in *DeleteInstancesRequest, opts ...grpc.CallOption) (*DeleteInstancesResponse, error) {
	out := new(DeleteInstancesResponse)
	err := c.cc.Invoke(ctx, KurtosisCloudBackendServer_DeleteInstances_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kurtosisCloudBackendServerClient) GetInstanceMetrics(ctx context.Context, in *GetInstanceMetricsRequest, opts ...grpc.CallOption) (*GetInstanceMetricsResponse, error) {
	out := new(GetInstanceMetricsResponse)
	err := c.cc.Invoke(ctx, KurtosisCloudBackendServer_GetInstanceMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedKurtosisCloudBackendServerServer) DeleteInstances(context.Context, *DeleteInstancesRequest) (*DeleteInstancesResponse, error) {
...
func (UnimplementedKurtosisCloudBackendServerServer) GetInstanceMetrics(context.Context, *GetInstanceMetricsRequest) (*GetInstanceMetricsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetInstanceMetrics not implemented")
}
...
func _KurtosisCloudBackendServer_DeleteInstances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteInstancesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KurtosisCloudBackendServerServer).DeleteInstances(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KurtosisCloudBackendServer_DeleteInstances_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KurtosisCloudBackendServerServer).DeleteInstances(ctx, req.(*DeleteInstancesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KurtosisCloudBackendServer_GetInstanceMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetInstanceMetricsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KurtosisCloudBackendServerServer).GetInstanceMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KurtosisCloudBackendServer_GetInstanceMetrics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KurtosisCloudBackendServerServer).GetInstanceMetrics(ctx, req.(*GetInstanceMetricsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KurtosisCloudBackendServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _KurtosisCloudBackendServer_DeleteInstances_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _KurtosisCloudBackendServer_GetInstanceMetrics_Handler,
		},
	},
