...
require (
	...
	github.com/kurtosis-tech/kurtosis-core/launcher v0.0.0-20220921193757-ffb1c5574dfd
...
require (
	...
	github.com/kurtosis-tech/kurtosis-core-sdk/api/golang v0.0.0-20220923213123-a5b18db21de6 // indirect
