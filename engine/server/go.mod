...
require (
	...
	github.com/kurtosis-tech/container-engine-lib v0.0.0-20220514003148-a75f6f4fab0a
	github.com/kurtosis-tech/kurtosis-core/launcher v0.0.0-20220515175941-cf339ea6aa9c
