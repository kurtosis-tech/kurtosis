...
const BreadCumbs = ({currentPath, handleOnClick}) => {
        ...
        <div className='flex flex-col h-[90%] space-y-1 overflow-auto'>
                {
                    ...
                    <div className="flex h-3/4 flex-col"> 
                        ...
                        <p className="break-all overflow-y-auto"> {detailInfo.textPreview} </p> 
                    </div>  :                      
    ...
    return (
        <div className="flex h-full">
            ...
            <div className="flex bg-white w-[calc(100vw-39rem)] flex-col space-y-5">
                ...
                <BreadCumbs currentPath={currentPath} handleOnClick={handleBreadCrumbClick} />
                {fileInfoLoading ? 
                    <LoadingOverlay /> : 
                    <FileInfoComponent 
                        files={currentFiles}
