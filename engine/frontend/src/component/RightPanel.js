...
const RightPanel = ({isServiceInfo, enclaveName}) => {
    ...
    return (
        <div className="flex-none w-[2rem] p-4 border-l bg-slate-800">
            <div className="flex flex-col space-y-10 items-center">
                ...
                {
                    isServiceInfo ? <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16" onClick={handleGoToEnclave}>
