...
interface IEngineServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  clean: grpc.MethodDefinition<engine_service_pb.CleanArgs, google_protobuf_empty_pb.Empty>;
}
...
export interface IEngineServiceServer extends grpc.UntypedServiceImplementation {
  ...
  clean: grpc.handleUnaryCall<engine_service_pb.CleanArgs, google_protobuf_empty_pb.Empty>;
}
...
export class EngineServiceClient extends grpc.Client {
  ...
  clean(argument: engine_service_pb.CleanArgs, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  clean(argument: engine_service_pb.CleanArgs, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  clean(argument: engine_service_pb.CleanArgs, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
}
